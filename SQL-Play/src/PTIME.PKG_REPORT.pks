  ...
  PROCEDURE RPT_PARA
   ...
   BEGIN
        ...
        ls_sql_store := ' S_STORE AS ( '
                      ...
                      || ' S.STOR_TP,CM1.CODE_NM STOR_TP_NM,S.RENTAL_DIV,'
                      ...
                      || ' S.STOR_TP,S.RENTAL_DIV,NVL(S.SIDO_CD,''999'') SIDO_CD,NVL(S.REGION_CD,''999999'') REGION_CD,NVL(S.TRAD_AREA,''99'') TRAD_AREA,'
                      || ' S.USE_YN,NVL(S.DEPT_CD,''9999999999'') DEPT_CD,NVL(S.TEAM_CD,''9999999999'') TEAM_CD,NVL(S.SV_USER_ID,''9999999999'') SV_USER_ID,S.BUSI_NO,'
