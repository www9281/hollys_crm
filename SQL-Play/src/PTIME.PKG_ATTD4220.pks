CREATE OR REPLACE PACKAGE       PKG_ATTD4220 AS
...
CREATE OR REPLACE PACKAGE BODY       PKG_ATTD4220 AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[   AND (:PSV_USER_TXT IS NULL OR (USER_ID LIKE '%'||:PSV_USER_TXT||'%' OR USER_NM LIKE '%'||:PSV_USER_TXT||'%')) ]'
        ...
        OPEN PR_RESULT FOR
            ...
            ls_sql USING PSV_GFR_DATE, PSV_GTO_DATE
                       ...
                       , PSV_USER_TXT, PSV_USER_TXT, PSV_USER_TXT;
