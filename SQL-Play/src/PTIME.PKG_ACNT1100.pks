CREATE OR REPLACE PACKAGE       PKG_ACNT1100 AS

    ---------------------------------------------------------------------------------------------------
    --  Package Name     : PKG_ACNT1100
    --  Description      : 전도금 월별 사용 현황
    -- Ref. Table        :
    ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY       PKG_ACNT1100 AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[    ,   SUM(C1.BEGIN_AMT + C1.IN_ETC_AMT - C1.OUT_ETC_AMT) OVER(PARTITION BY C1.COMP_CD, C1.STOR_CD ORDER BY C1.DISP_SEQ)]'
        ||CHR(13)||CHR(10)||Q'[      - C1.IN_ETC_AMT    ]'
        ||CHR(13)||CHR(10)||Q'[      + C1.OUT_ETC_AMT  AS BEGIN_AMT    ]'
        ||CHR(13)||CHR(10)||Q'[    ,   C1.IN_ETC_AMT    ]'
        ||CHR(13)||CHR(10)||Q'[    ,   C1.OUT_ETC_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[    ,   SUM(C1.BEGIN_AMT + C1.IN_ETC_AMT - C1.OUT_ETC_AMT) OVER(PARTITION BY C1.COMP_CD, C1.STOR_CD ORDER BY C1.DISP_SEQ)   AS END_AMT    ]'
