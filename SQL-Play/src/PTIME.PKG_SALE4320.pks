CREATE OR REPLACE PACKAGE      PKG_SALE4320 AS

    ---------------------------------------------------------------------------------------------------
    --  Package Name     : PKG_SALE4320
    --  Description      : 전년비 판매 추이 
    -- Ref. Table        :
    ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY      PKG_SALE4320 AS
    PROCEDURE SP_MAIN /* 딜리버리 전년비 판매 추이  */
    (
        PSV_COMP_CD     IN  VARCHAR2 ,              -- 회사코드
        PSV_USER        IN  VARCHAR2 ,              -- LOGIN USER
        PSV_PGM_ID      IN  VARCHAR2 ,              -- Progrm ID
    ...
    */
        ...
        ||CHR(13)||CHR(10)|| Q'[     ,  SUM(S.QTY_PREV) AS QTY_PREV                 ]'
        ||CHR(13)||CHR(10)|| Q'[     ,  SUM(S.AMT_PREV) AS AMT_PREV                 ]'
        ||CHR(13)||CHR(10)|| Q'[     ,  SUM(S.QTY_THIS) AS QTY_THIS                 ]'
        ||CHR(13)||CHR(10)|| Q'[     ,  SUM(S.AMT_THIS) AS AMT_THIS                 ]'
        ||CHR(13)||CHR(10)|| Q'[  FROM  (                                           ]'
        ||CHR(13)||CHR(10)|| Q'[            SELECT  SJ.BRAND_CD                     ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  MAX(S.BRAND_NM) AS BRAND_NM     ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  SJ.STOR_CD                      ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  MAX(S.STOR_NM)  AS STOR_NM      ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  SUM(SJ.SALE_QTY)                                                                       AS  QTY_PREV  ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  SUM(DECODE(:PSV_FILTER, 'G', SJ.GRD_AMT, 'T', SJ.SALE_AMT, SJ.GRD_AMT - SJ.VAT_AMT))   AS  AMT_PREV  ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  0                                                                                      AS  QTY_THIS  ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  0                                                                                      AS  AMT_THIS  ]'
        ...
        ||CHR(13)||CHR(10)|| Q'[               AND  SJ.SALE_YM LIKE TO_CHAR(ADD_MONTHS(TO_DATE(:PSV_YEAR, 'YYYY'), - 12), 'YYYY')||'%']'
        ...
        ||CHR(13)||CHR(10)|| Q'[                 ,  SJ.STOR_CD                      ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  MAX(S.STOR_NM)  AS STOR_NM      ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  0                                                                                      AS  QTY_PREV  ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  0                                                                                      AS  AMT_PREV  ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  SUM(SJ.SALE_QTY)                                                                       AS  QTY_THIS  ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  SUM(DECODE(:PSV_FILTER, 'G', SJ.GRD_AMT, 'T', SJ.SALE_AMT, SJ.GRD_AMT - SJ.VAT_AMT))   AS  AMT_THIS  ]'
        ||CHR(13)||CHR(10)|| Q'[              FROM  SALE_JMO    SJ                  ]'
        ||CHR(13)||CHR(10)|| Q'[                 ,  S_STORE     S                   ]'
        ||CHR(13)||CHR(10)|| Q'[             WHERE  SJ.COMP_CD  = S.COMP_CD         ]'
        ||CHR(13)||CHR(10)|| Q'[               AND  SJ.BRAND_CD = S.BRAND_CD        ]'
        ...
        OPEN PR_RESULT FOR
           ls_sql USING PSV_FILTER, PSV_COMP_CD, PSV_YEAR, PSV_FILTER, PSV_COMP_CD, PSV_YEAR;
