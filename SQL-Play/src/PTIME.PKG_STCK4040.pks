CREATE OR REPLACE PACKAGE       PKG_STCK4040 AS

    ---------------------------------------------------------------------------------------------------
    --  Package Name     : PKG_STCK4040
    --  Description      : 월 수불 현황 
    -- Ref. Table        :
    ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY       PKG_STCK4040 AS
                ...
                SELECT  S.COMP_CD
                  ...
                  FROM  (
                            SELECT  /*+ ORDERED */
                                 ...
                                 ,  MAX(ROUND(CASE WHEN I.ORD_UNIT_QTY > 0 THEN NVL(D.COST, 0) / I.ORD_UNIT_QTY ELSE 0 END, 3))    AS COST
                                 ...
                                 ,  SUM(D.END_QTY)          AS END_QTY
                                 ,  SUM(D.END_AMT)          AS END_AMT
                              FROM  (
                                 ...
                                 ,  (
                                        ...
                                        SELECT  A.COMP_CD
                                         ...
                                         WHERE  A.COMP_CD       = B.COMP_CD(+)
                                           ...
                                           AND  I.BRAND_CD      = PSV_BRAND_CD
                                           AND  I.STOR_TP       = LS_STOR_TP
                                           AND  B.PRC_YM(+)     = TO_CHAR(TO_DATE(A.IN_CONF_DT, 'YYYYMMDD'), 'YYYYMM')
                                        ...
                                        SELECT  A.COMP_CD
                                         ...
                                         WHERE  A.COMP_CD       = B.COMP_CD(+)
                                           ...
                                           AND  I.BRAND_CD      = PSV_BRAND_CD
                                           AND  I.STOR_TP       = LS_STOR_TP
                                           AND  B.PRC_YM(+)     = TO_CHAR(TO_DATE(A.OUT_CONF_DT, 'YYYYMMDD'), 'YYYYMM')
