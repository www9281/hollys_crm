CREATE OR REPLACE PACKAGE      PKG_SALE1170 AS

   ---------------------------------------------------------------------------------------------------
   --  Package Name     : PKG_SALE1170
   --  Description      : 세트옵션상품 선호도 분석
   -- Ref. Table        :
   ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY      PKG_SALE1170 AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[               FROM  SALE_DT     SJ  ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  S_STORE     S   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  (               ]'
        ||CHR(13)||CHR(10)||Q'[                         SELECT  O.COMP_CD       ]'
        ||CHR(13)||CHR(10)||Q'[                              ,  O.BRAND_CD      ]'
        ||CHR(13)||CHR(10)||Q'[                              ,  O.ITEM_CD       ]'
        ||CHR(13)||CHR(10)||Q'[                           FROM  OPTION_ITEM O   ]'
        ||CHR(13)||CHR(10)||Q'[                          WHERE  O.COMP_CD   = :PSV_COMP_CD  ]'
        ||CHR(13)||CHR(10)||Q'[                            AND  O.USE_YN    = 'Y'           ]'
        ||CHR(13)||CHR(10)||Q'[                          GROUP  BY O.COMP_CD, O.BRAND_CD, O.ITEM_CD ]'
        ||CHR(13)||CHR(10)||Q'[                      )          OI  ]'
        ...
        ||CHR(13)||CHR(10)||Q'[                AND  SJ.COMP_CD  = OI.COMP_CD    ]'
        ||CHR(13)||CHR(10)||Q'[                AND  SJ.BRAND_CD = OI.BRAND_CD   ]'
        ||CHR(13)||CHR(10)||Q'[                AND  SJ.ITEM_CD  = OI.ITEM_CD    ]'
        ...
        ||CHR(13)||CHR(10)||Q'[                AND  SJ.T_SEQ <> '0'     ]'
        ...
        OPEN PR_RESULT FOR
            ls_sql USING PSV_COMP_CD, PSV_COMP_CD, PSV_GFR_DATE, PSV_GTO_DATE;
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[                              ,  MAIN_ITEM_CD    AS ITEM_CD  ]'
        ||CHR(13)||CHR(10)||Q'[                              ,  TR_GR_NO        AS TR_GR_NO ]'
        ...
        ||CHR(13)||CHR(10)||Q'[                AND  A.ITEM_CD   = SD.ITEM_CD    ]'
        ||CHR(13)||CHR(10)||Q'[                AND  A.TR_GR_NO  = SD.TR_GR_NO   ]'
