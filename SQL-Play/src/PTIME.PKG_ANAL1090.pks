CREATE OR REPLACE PACKAGE      PKG_ANAL1090 AS

    ---------------------------------------------------------------------------------------------------
    --  Package Name     : PKG_ANAL1090
    --  Description      : 원가 시뮬레이션(레시피)
    -- Ref. Table        :
    ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY      PKG_ANAL1090 AS
    ...
    IS
    /******************************************************************************
        NAME:       SP_MAIN_01        원가 시뮬레이션(레시피) - 표준원가
        PURPOSE:
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  V1.C_ITEM_QTY   ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V1.C_ITEM_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V1.C_ITEM_COST  ]'
        ||CHR(13)||CHR(10)||Q'[   FROM  S_ITEM      C1  ]'  -- 상품
        ||CHR(13)||CHR(10)||Q'[      ,  S_ITEM      C2  ]'  -- 원자재
        ||CHR(13)||CHR(10)||Q'[      ,  (               ]'
        ||CHR(13)||CHR(10)||Q'[             SELECT  ICR.COMP_CD                         ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.BRAND_CD                        ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  STR.BRAND_NM                        ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.STOR_CD                         ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  STR.STOR_NM                         ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.C_ITEM_CD                       ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.P_ITEM_CD                       ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.STD_QTY         AS C_ITEM_QTY   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.STD_AMT         AS C_ITEM_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.STD_COST        AS C_ITEM_COST  ]'
    ...
    IS
    /******************************************************************************
        NAME:       SP_MAIN_02        원가 시뮬레이션(레시피) - 실행원가
        PURPOSE:
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.C_ITEM_CD                       ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.P_ITEM_CD                       ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.RUN_QTY         AS C_ITEM_QTY   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.RUN_AMT         AS C_ITEM_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICR.RUN_COST        AS C_ITEM_COST  ]'
        ||CHR(13)||CHR(10)||Q'[               FROM  ITEM_CHAIN_RCP  ICR                 ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  S_STORE         STR                 ]'
        ||CHR(13)||CHR(10)||Q'[              WHERE  ICR.COMP_CD     = STR.COMP_CD       ]'
        ||CHR(13)||CHR(10)||Q'[                AND  ICR.BRAND_CD    = STR.BRAND_CD      ]'
    ...
    IS
    /******************************************************************************
        NAME:       SP_MAIN_03        원가 시뮬레이션(레시피) - 가상원가
        PURPOSE:
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  VER.C_ITEM_CD                       ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICS.RUN_QTY                 AS C_ITEM_QTY   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ICS.RUN_QTY * VER.DO_COST   AS C_ITEM_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  VER.DO_COST                 AS C_ITEM_COST  ]'
