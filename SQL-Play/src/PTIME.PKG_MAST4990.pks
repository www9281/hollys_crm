CREATE OR REPLACE PACKAGE      PKG_MAST4990 AS

---------------------------------------------------------------------------------------------------
-- Package Name : PKG_MAST4990
-- Description : GIFT STOCK REPORT
-- Ref. Table :
---------------------------------------------------------------------------------------------------
-- Create Date : 2013-03-18
-- Create Programer : 唱扁龋
...
(
    ...
    PR_RTN_CD OUT VARCHAR2 , -- 贸府内靛
    PR_RTN_MSG OUT VARCHAR2 -- 贸府Message -- 贸府Message
);
...
CREATE OR REPLACE PACKAGE BODY      PKG_MAST4990 AS
