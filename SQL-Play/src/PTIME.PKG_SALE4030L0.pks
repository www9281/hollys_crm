CREATE OR REPLACE PACKAGE      PKG_SALE4030L0 AS
    PROCEDURE SP_SALE4030 /*일별 시간대별 매출*/
    ( 
...
CREATE OR REPLACE PACKAGE BODY      PKG_SALE4030L0 AS
    PROCEDURE SP_SALE4030 /*일별 시간대별 매출*/
    ( 
        PSV_COMP_CD     IN  VARCHAR2 ,                -- 회사코드
        PSV_USER        IN  VARCHAR2 ,                -- LOGIN USER
...
--    dbms_output.put_line(ls_sql) ;
    ...
    BEGIN
        EXECUTE IMMEDIATE  
            ...
            USING PSV_COMP_CD, PSV_LANG_CD, PSV_COMP_CD, PSV_GFR_DATE, PSV_GTO_DATE, PSV_FR_TM, PSV_TO_TM;
...
/* PIVOT 구현 - FROM 절과 PIVOT 컬럼 정의*/
    V_SQL :=   ' SELECT * '
            ...
            ||CHR(13)||CHR(10)||Q'[ (SUM(GRD_AMT) VCOL1, (SUM(SALE_QTY) VCOL2  ]';
        
        V_SQL := V_SQL    
            ||CHR(13)||CHR(10)||Q'[ FOR (SEC_DIV ) IN ( ]'
            ||CHR(13)||CHR(10)||Q'[ V_CROSSTAB ]'
            ||CHR(13)||CHR(10)||Q'[ ) ) ]'
...
--       dbms_output.put_line( V_HD) ;
    ...
    OPEN PR_HEADER FOR
      V_HD;
    OPEN PR_RESULT FOR
      V_SQL USING PSV_COMP_CD, PSV_LANG_CD, PSV_FILTER, PSV_FILTER, PSV_COMP_CD, PSV_GFR_DATE, PSV_GTO_DATE, PSV_FR_TM, PSV_TO_TM;
