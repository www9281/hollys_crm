CREATE OR REPLACE PACKAGE       PKG_SALE5350 IS
/******************************************************************************
   NAME:       PKG_SALE5350
   PURPOSE:    매출관리> 매출분석 > 신용카드 매출 현황

   REVISIONS:
   Ver        Date        Author           Description
   ---------  ----------  ---------------  ------------------------------------
   1.0        2012-01-18             1. Created this package.
******************************************************************************/
...
CREATE OR REPLACE PACKAGE BODY       PKG_SALE5350 AS
/******************************************************************************
   NAME:       PKG_SALE5350
   PURPOSE:
...
******************************************************************************/
   ...
   -----------------------------------------------------------------------------
    ...
    BEGIN
        ...
        || chr(13)||chr(10) || q'[                       , SUM(S.APPR_AMT + S.RTN_PAY_AMT) AS PAY_AMT  ]'
        || chr(13)||chr(10) || q'[                       , SUM(S.SALE_CNT - S.RTN_CNT) AS PAY_CNT      ]'
        || chr(13)||chr(10) || q'[                    FROM SALE_JDC S                                  ]'
        || chr(13)||chr(10) || q'[                    WHERE S.COMP_CD = :PSV_COMP_CD                   ]'
        || chr(13)||chr(10) || q'[                     AND S.PAY_DIV = '20'                            ]'
