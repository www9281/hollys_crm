CREATE OR REPLACE PACKAGE      PKG_ORDR1240 AS

    ---------------------------------------------------------------------------------------------------
    --  Package Name     : PKG_ORDR1240
    --  Description      : 주문현황(공급업체) 
    -- Ref. Table        :
    ---------------------------------------------------------------------------------------------------
    ...
    ( 
        ...
        PSV_STOR_TXT    IN  VARCHAR2 ,                -- 점포코드/명
...
CREATE OR REPLACE PACKAGE BODY       PKG_ORDR1240 AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[    AND  DECODE(:PSV_DT_TP, 'O', OD.ORD_DT, 'D', OD.DLV_DT) BETWEEN :PSV_GFR_DATE AND :PSV_GTO_DATE ]'
        --||CHR(13)||CHR(10)||Q'[    AND  (:PSV_BRAND_CD  IS NULL OR OD.BRAND_CD  = :PSV_BRAND_CD)  ]'
        ||CHR(13)||CHR(10)||Q'[    AND  (:PSV_VENDOR_CD IS NULL OR OD.VENDOR_CD = :PSV_VENDOR_CD) ]'
        ||CHR(13)||CHR(10)||Q'[    AND  (:PSV_STOR_TXT IS NULL OR (OD.STOR_CD LIKE '%'||:PSV_STOR_TXT||'%' OR S.STOR_NM LIKE '%'||:PSV_STOR_TXT||'%'))  ]'
        ...
        OPEN PR_RESULT FOR
            ls_sql USING PSV_COMP_CD, PSV_ORD_FG, PSV_DT_TP, PSV_GFR_DATE, PSV_GTO_DATE, PSV_VENDOR_CD, PSV_VENDOR_CD, PSV_STOR_TXT, PSV_STOR_TXT, PSV_STOR_TXT;
    ...
    ******************************************************************************/
    ...
    IS
    /******************************************************************************
        NAME:       SP_TAB04     주문현황(공급업체) - 점포별 품목별
        PURPOSE:
    ...
    BEGIN
        ...
        OPEN PR_RESULT FOR
            ls_sql USING PSV_COMP_CD, PSV_LANG_CD
                       ...
                       , PSV_COMP_CD, PSV_ORD_FG, PSV_DT_TP, PSV_GFR_DATE, PSV_GTO_DATE, PSV_VENDOR_CD, PSV_VENDOR_CD, PSV_STOR_TXT, PSV_STOR_TXT, PSV_STOR_TXT;
