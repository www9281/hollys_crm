CREATE OR REPLACE PACKAGE      PKG_ANAL1070 AS

    ---------------------------------------------------------------------------------------------------
    --  Package Name     : PKG_ANAL1070
    --  Description      : 메뉴레시피원가
    -- Ref. Table        :
    ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY      PKG_ANAL1070 AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[    AND  (:PSV_ITEM_TXT IS NULL OR (V1.P_ITEM_CD LIKE '%'||:PSV_ITEM_TXT||'%' OR C1.ITEM_NM LIKE '%'||:PSV_ITEM_TXT||'%'))   ]'
