CREATE OR REPLACE PACKAGE       PKG_SALE4170 AS

    ---------------------------------------------------------------------------------------------------
    --  Package Name     : PKG_SALE4170
    --  Description      : 상품권별 매출현황
    -- Ref. Table        :
    ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY       PKG_SALE4170 AS
    ...
    IS
    /******************************************************************************
        NAME:       SP_MAIN     상품권 매출현황
        PURPOSE:
        
        REVISIONS:
        VER        DATE        AUTHOR           DESCRIPTION
        ---------  ----------  ---------------  ------------------------------------
        1.0        2017-09-25         1. CREATED THIS PROCEDURE.
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.POS_NO                       ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.BILL_NO                      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.SALE_DIV                     ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.CARD_NO      AS GIFT_CD      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  GM.GIFT_NM      AS GIFT_NM      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.CARD_NO      AS GIFT_NO      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.PAY_AMT      AS GIFT_PRICE   ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.PAY_AMT - (SJ.CHANGE_AMT + SJ.REMAIN_AMT)   AS PAY_AMT      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.CHANGE_AMT   AS CHANGE_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.REMAIN_AMT   AS REMAIN_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[   FROM  SALE_ST         SJ  ]'
        ...
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.APPR_MAEIP_CD  = GM.GIFT_CD    ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.COMP_CD  = :PSV_COMP_CD  ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.PAY_DIV  = '40'          ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.SALE_DT  BETWEEN :PSV_GFR_DATE AND :PSV_GTO_DATE ]'
        ||CHR(13)||CHR(10)||Q'[    AND  (:PSV_GIFT_CD IS NULL OR SJ.APPR_MAEIP_CD = :PSV_GIFT_CD) ]'
        ||CHR(13)||CHR(10)||Q'[  ORDER  BY SJ.BRAND_CD  ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.STOR_CD      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.SALE_DT      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.POS_NO       ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.BILL_NO      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.CARD_NO      ]';
