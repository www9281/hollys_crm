CREATE OR REPLACE PACKAGE       PKG_SALE4660 AS

    ---------------------------------------------------------------------------------------------------
    --  Package Name     : PKG_SALE4660
    --  Description      : 월별 매출현황 
    -- Ref. Table        :
    ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY       PKG_SALE4660 AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[             SELECT  SJ.COMP_CD, SUBSTR(SJ.SALE_DT, 1, 6) AS SALE_YM ]'
        ...
        ||CHR(13)||CHR(10)||Q'[              GROUP  BY SJ.COMP_CD, SUBSTR(SJ.SALE_DT, 1, 6) ]'
        ||CHR(13)||CHR(10)||Q'[         )   SJ          ]'
        ||CHR(13)||CHR(10)||Q'[      ,  (               ]'
        ||CHR(13)||CHR(10)||Q'[             SELECT  SP.COMP_CD, SUBSTR(SP.SALE_DT, 1, 6) AS SALE_YM  ]'
        ...
        ||CHR(13)||CHR(10)||Q'[              GROUP  BY SP.COMP_CD, SUBSTR(SP.SALE_DT, 1, 6) ]'
        ||CHR(13)||CHR(10)||Q'[         )   SP          ]'
        ||CHR(13)||CHR(10)||Q'[  WHERE  SJ.COMP_CD  = SP.COMP_CD    ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.SALE_YM  = SP.SALE_YM    ]'
