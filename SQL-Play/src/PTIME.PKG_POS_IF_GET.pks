...
--  Description      : POS마스터 수신용
--  asWorkDiv        : 00 => (프로시져 호출 테스트)
--                   : 01 => ITEM_CHAIN       (상품마스터)
--                   : 02 => ITEM_BRAND_HIS   (상품단가이력)                    > 제거함
--                   : 03 => FIXED_ITEM       (고정플레이버)                    > 제거함
--                   : 04 => SET_GRP_RULE     (세트상품),  SET_GRP_ITEM (세트조합마스터)
--                   : 05 => BUNDLE_HD        (묶음상품 HD)
--                   : 06 => BUNDLE_DT        (묶음상품 DT)
--                   : 07 => STORE_ITEM_PRT   (주방오더 프린터 상품)
--                   : 08 => BEST_ITEM        (인기상품)
--                   : 09 => TOUCH_STORE_UI   (점포별 포스 터치키)
--                   : 10 => SUB_TOUCH_UI     (부가상품터치키그룹)
--                   : 11 => ITEM_EXT_GRP     (상품별 부가상품 그룹)
--                   : 12 => BUTTON_INFO      (버튼정보)
--                   : 13 => OPTION_ITEM      (옵션상품)
--                   : 14 => ITEM_OPTION_RULE (옵션상품 RULE)
--                   : 15 => GIFT_CODE_MST    (상품권 권종 마스터)
--                   : 16 => ACC_MST          (기타입출금)
--                   : 17 => ACC_RMK          (기타입출금 적요 마스터)
--                   : 18 => CAMPAIGN_SAVE    (캠페인 할인/적립마스터)          > 제거함
--                   : 19 => CAMPAIGN_ITEM    (캠페인 상품)                     > 제거함
--                   : 20 => CAMPAIGN_WEEK    (캠페인 적용 요일/시간)           > 제거함
--                   : 21 => CAMPAING_GIFT    (캠페인 복권/사은품 마스터)       > 제거함
--                   : 22 => CAMPAING_RULE    (캠페인 RULE)                     > 제거함
--                   : 23 => FLAVOR_TOUCH_STORE_UI  (점포별 플레이버 터치키)    > 제거함
--                   : 24 => PLU_NM_BRAND           (PLU 상품명)                > 제거함
--                   : 25 => PLU_AMT_STORE          (PLU 금액 - 점포기준)       > 제거함
--                   : 26 => ITEM_L_CLASS           (대분류)
--                   : 27 => ITEM_M_CLASS           (중분류)
--                   : 28 => ITEM_S_CLASS           (소분류)
--                   : 29 => ITEM_KITCHEN           (주방상품정보)
--                   : 30 => CAMPAIGN_PREFIX        (이중할인 - CARD PREFIX)    > 제거함
--                   : 31 => SET_RULE               (세트 구성품 정보)
--                   : 32 => STORE_ITEM_PRT_MULTI   (주방오더 프린터 상품(다중))
--                   : 33 => ITEM_CLASS             (상품분류(공통제외))
--                   : 34 => SET_GRP                (Mix Match 그룹정보)        > 제거함
--                   : 50 => STORE_USER             (담당자 마스터)
--                   : 51 => STORE_CHK_M            (점포 점검 마스터)          > 검토
--                   : 52 => CARD                   (카드사 마스터)
--                   : 53 => CARDMB_PREFIX          (카드사 PREFIX)
--                   : 54 => COMMON                 (공통코드 마스터)
--                   : 55 => VAN                    (VAN 마스터)                > 제거함
--                   : 56 => CAT ID                 (CAT ID 마스터)             > 제거함
--                   : 57 => VAN, CATID,            (VAN,카드 정보)
--                   : 58 => STORE                  (점포정보)
--                   : 59 => BILL_MSG_HQ            (본사 명판)
--                   : 60 => BILL_MSG_STOR          (점포 명판)
--                   : 61 => COMMON                 (송수신 URL)
--                   : 62 => STORE_PURCHASE         (점별 매입처)               > 검토
--                   : 63 => POS_PGM_AUTH           (프로그램 권한)
--                   : 64 => SATISFACTION           (만족도 마스터)             > 제거함
--                   : 65 => EX_DAY, EX_CURR        (환율 마스터)               > 제거함
--                   : 66 => CUSTOMER               (고객 마스터)               > 제거함
--                   : 67 => STORE_WEEK             (점포 운영시간CNT 테크 I/F) > 제거함
--                   : 68 => STORE_HOLIDAY          (점포 휴무일)               > 제거함
--                   : 70 => REGION                 (지역 마스터)               > 제거함
--                   : 71 => LANG_ITEM              (다국어 상품마스터)
--                   : 72 => LANG_COMMON            (다국어 공통마스터)
--                   : 73 => LANG_STORE             (다국어 점포마스터)
--                   : 74 => LANG_TABLE             (다국어 테이블마스터)
--                   : 75 => RECIPE_BRAND           (PL형태의 레시피마스터)
--                   : 80 => RESV_SALE_HD           (예약 HEADER)               > 제거함
--                   : 81 => RESV_SALE_DT           (예약 DETAIL)               > 제거함
--                   : 82 => RESV_SALE_ST           (예약 결제)                 > 제거함
--                   : 83 => RESV_SALE_DESC         (예약 내용)                 > 제거함
--                   : 84 => DC                     (할인 정보)
--                   : 85 => DC_STORE               (점포별 할인정보)
--                   : 86 => DC_ITEM                (할인 대상상품)
--                   : 87 => DC_GIFT                (할인 사은품)
--                   : 88 => STORE                  (B2B)
--                   : 89 => DC_WEEK                (할인대상요일)
--                   : 90 =>                        (서버시간 리턴)
--                   : 91 => DC_ITEM_GRP            (할인대상상품그룹)
--                   : A0 => BITEM_B2B_DC_HIS       (B2B 아이템 DB 할인 정책)
--                   : A1 => ITEM_STOCK_PERIOD      (반제품 해동시간관리)
--                   : A2 => ITEM_CHAIN             (반제품, 원부자재 상품리스트(KDS용))
--                   : A3 => RECIPE_BRAND_FOOD      (BOM형태의 레시피정보)
--                   : B0 => CS_PROGRAM             ([서비스]프로그램 마스터)
--                   : B1 => CS_PROGRAM_MATL        ([서비스]프로그램 대상 교구)
--                   : B2 => CS_PROGRAM_ORG         ([서비스]프로그램 단체고객수 구간 할인율)
--                   : B3 => CS_PROGRAM_STORE       ([서비스]프로그램 점포설정)
--                   : B4 => CS_PROGRAM_STORE_TM    ([서비스]프로그램 점포 운영시간)
--                   : B5 => CS_MEMBERSHIP          ([서비스]회원권 마스터)
--                   : B6 => CS_OPTION              ([서비스]입장옵션 마스터)
--                   : B7 => CS_OPTION_STORE        ([서비스]입장옵션 점포할당 마스터)
--                   : B8 => CS_MEMBERSHIP_ITEM     ([서비스]회원권 대상상품 마스터)
--                   : B9 => CS_CONTENT             ([서비스]SMS 컨텐츠)
--                   : C0 => M_COUPON_MST           ([서비스]모바일쿠폰 마스터)
--                   : C1 => M_COUPON_STORE         ([서비스]쿠폰 대상매장 마스터)
--                   : C2 => M_COUPON_ITEM          ([서비스]쿠폰 대상상품 마스터)
--------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY       PKG_POS_IF_GET AS
  ...
  BEGIN
    ...
    SELECT I.BRAND_CD      AS BRAND_CD      -- 영업조직
         ...
         , ''              AS FLAVOR_DIV    -- 플레이버관리구분 > 사용안함
         , NVL( NVL(T.STOR_SALE_PRC, I.SALE_PRC), 0)    AS SALE_AMT -- 판매가
         , NVL(I.NODC_YN , 'N') AS NODC_YN -- 할인 불가 품목여부 => Y : 할인불가,  N : 할인가능
         ...
         , NVL( DECODE( I.SALE_PRC_CTRL, 'S', NVL(T.SALE_VAT_IN_RATE , I.SALE_VAT_IN_RATE ), I.SALE_VAT_IN_RATE ), 0) AS SALE_VAT_IN_RATE -- 테이크인 판매 VAT율
         , NVL( DECODE( I.SALE_PRC_CTRL, 'S', NVL(T.SALE_VAT_OUT_RATE, I.SALE_VAT_OUT_RATE), I.SALE_VAT_OUT_RATE), 0) AS SALE_VAT_OUT_RATE -- 테이크아웃 판매 VAT율
  ...
  BEGIN
    ...
    SELECT I.BRAND_CD    BRAND_CD    -- 영업조직
         ...
         , I.REF_ITEM_YN REF_ITEM_YN -- 연계상품여부
         , I.ITEM_CD     ITEM_CD -- 연계상품코드
         , NVL(I.STOCK_YN, 'N')  STOCK_YN -- 재고관리여부
  ...
  IF P_COMP_CD <> '012' THEN
        ...
        OPEN p_cursor FOR
            SELECT  SU.BRAND_CD     BRAND_CD    -- 영업조직
                  ...
                  , SU.REJECT_PWD   REJECT_PWD  -- 반품비밀번호
    ...
    SELECT 'INTERFACEINFO' ,
      ...
      FROM (WITH VA AS (
            ...
            SELECT 'VAN_DIV' AS FLAG_NM ,
             ...
             WHERE CODE_CD = '02'
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'CARD_APPR_DIV' , 2, 'CARD_IP', 3, 'CARD_PORT', 4, 'CARD_ID') AS FLAG_NM -- 점포별 : CARD_ID
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'KORAIL_APPR_DIV', 2, 'KORAIL_IP', 3, 'KORAIL_PORT', 4, 'KORAIL_ID') AS FLAG_NM -- 점포별 : KORAIL_ID
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'GIFTCON_DIV' , 2, 'GIFTCON_IP', 3, 'GIFTCON_PORT', 4, 'GIFTCON_ID') AS FLAG_NM -- 점포별 : GIFTCON_ID
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '12'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'GIFTSHOW_DIV' , 2, 'GIFTSHOW_IP', 3, 'GIFTSHOW_PORT', 4, 'GIFTSHOW_ID') AS FLAG_NM -- 점보별 : GIFTSHOW_ID
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '13'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'HARTCON_DIV' , 2, 'HARTCON_IP', 3, 'HARTCON_PORT', 4, 'HARTCON_ID') AS FLAG_NM -- 점포별 : HARTCON_ID
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '14'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'SAMSUNCON_DIV' , 2, 'SAMSUNCON_IP', 3, 'SAMSUNCON_PORT', 4, 'SAMSUNCON_ID') AS FLAG_NM -- 점포별 : SAMSUNCON_ID
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '15'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'QPCON_DIV' , 2, 'QPCON_IP', 3, 'QPCON_PORT', 4, 'QPCON_ID') AS FLAG_NM -- 점포별 : QPCON_ID
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '16'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'HPYCON_DIV' , 2, 'HPYCON_IP', 3, 'HPYCON_PORT', 4, 'HPYCON_ID') AS FLAG_NM -- 점포별 : HPYCON_ID
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '17'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'OCB_DIV' , 2, 'OCB_BSID', 3, 'OCB_NO', 4, 'OCB_PS' ) AS FLAG_NM -- 점포별 : OCB_BSID, OCB_NO, OCB_PS
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'HPYPP_DIV' , 2, 'HPYPP_IP', 3, 'HPYPP_PORT', 4, 'HPYPP_ID') AS FLAG_NM -- 점포별 : HPYPP_ID
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '19'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'GIFT_DIV' , 2, 'GIFT_IP', 3, 'GIFT_PORT', 4, 'GIFT_ID') AS FLAG_NM -- 점포별 : GIFT_ID
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'EMPDC_DIV' , 2, 'EMPDC_IP', 3, 'EMPDC_PORT', 4, 'EMPDC_ID') AS FLAG_NM -- 점포별 : EMPDC_ID
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'PREPAY_DIV' , 2, 'PREPAY_IP', 3, 'PREPAY_PORT', 4, 'PREPAY_ID') AS FLAG_NM -- 점포별 : PREPAY_ID
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, VAL_C1 , 3, VAL_N1 , 4, '' ) AS FLAG_VAL
              FROM (SELECT *
                      FROM CM
                     WHERE CODE_CD = '22'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'KAKAO_DIV' , 2, 'KAKAO_IP', 3, 'KAKAO_PORT', 4, 'KAKAO_ID') AS FLAG_NM -- 점포별 :카카오톡
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, VAL_C1 , 3, VAL_N1 , 4, '' ) AS FLAG_VAL
              FROM (SELECT *
                      FROM CM
                     WHERE CODE_CD = '23'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'M12_DIV' , 2, 'M12_IP', 3, 'M12_PORT', 4, 'M12_ID') AS FLAG_NM -- 점포별 :M12
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '24'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'WMP_DIV'       , 2, 'WMP_COMP_ID', 3, 'WMP_IP', 4, 'WMP_PORT') AS FLAG_NM        -- 위메프승인
            ...
            UNION ALL
            SELECT  DECODE(LEVEL, 1, 'VAN_TYPE' , 2, 'VAN_TID', 3, 'VAN_IP', 4, 'VAN_PORT') AS FLAG_NM          -- VAN(결제)
            ...
            UNION ALL
            SELECT  DECODE(LEVEL, 1, 'VAN2_TYPE' , 2, 'VAN2_TID', 3, 'VAN2_IP', 4, 'VAN2_PORT') AS FLAG_NM      -- VAN(유가증권)
                 ,  DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, CAT_ID , 3, IP , 4, PORT ) AS FLAG_VAL
              FROM  (
                        SELECT  V.*
                          FROM  STORE   S
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'CP_DIV' , 2, 'CP_COMP_ID', 3, 'CP_IP', 4, 'CP_PORT') AS FLAG_NM        -- 쿠팡승인
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1, 'PAS_DIV' , 2, 'PAS_IP', 3, 'PAS_PORT', 4, 'PAS_COMP') AS FLAG_NM -- 페이즈(카카오상품권)
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '31'
            ...
            UNION ALL
            SELECT DECODE(LEVEL, 1,  'EZWEL_DIV' , 2, 'EZWEL_IP', 3, 'EZWEL_PORT', 4, 'EZWEL_COMP') AS FLAG_NM -- 이지웰(복지몰)
                 , DECODE(LEVEL, 1, NVL(USE_YN, '0'), 2, IP , 3, PORT , 4, CAT_ID ) AS FLAG_VAL
              FROM (SELECT *
                      FROM VA
                     WHERE CODE_CD = '32'
  ...
  BEGIN
    OPEN p_cursor FOR
            SELECT  I1.BRAND_CD                         -- 영업조직
                 ...
                 ,  '0'         AS SALE_AMT             -- 판매가
                 ,  'Y'         AS NODC_YN              -- 할인 불가 품목여부 => Y : 할인불가,  N : 할인가능
                 ,  '0'         AS SALE_DC_DIV          -- 할인 적용 구분     => 0:정상, 1:판매가 미정의, 2:점포변경
                 ,  '0'         AS SALE_DC_PRC          -- 할인금액           => 세트조합 후 판매가 결정이 되면 할인금액 적용
