CREATE OR REPLACE PACKAGE       PKG_SALE4140 AS

   ---------------------------------------------------------------------------------------------------
   --  Package Name     : PKG_SALE4140
   --  Description      : 분류별 매출(일자별-한점포)
   -- Ref. Table        :
   ---------------------------------------------------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY       PKG_SALE4140 AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(V01.SALE_QTY) OVER(PARTITION BY V01.BRAND_CD, V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD, V01.ITEM_CD) AS TOT_SALE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(V01.SALE_AMT) OVER(PARTITION BY V01.BRAND_CD, V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD, V01.ITEM_CD) AS TOT_SALE_AMT ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(V01.COST_AMT) OVER(PARTITION BY V01.BRAND_CD, V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD, V01.ITEM_CD) AS TOT_COST_AMT ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V01.SALE_DT     ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V01.SALE_QTY    ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V01.SALE_AMT    ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V01.COST_AMT    ]'
