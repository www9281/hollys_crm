--------------------------------------------------------
--  DDL for Package Body PKG_SALE1470
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE1470" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ls_sql_main := ''
        ||CHR(13)||CHR(10)||Q'[ SELECT  SJ.WEEK_DAY     ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.WEEK_DAY_CNT ]'
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  ROUND(SJ.CUST_CNT/ NULLIF(SJ.WEEK_DAY_CNT,0), 0)   AS AVG_CUST_CNT ]'
        ||CHR(13)||CHR(10)||Q'[      ,  ROUND(SJ.NET_AMT / NULLIF(SJ.WEEK_DAY_CNT,0), 0)   AS AVG_NET_AMT  ]'
        ...
        ||CHR(13)||CHR(10)||Q'[             SELECT  TO_CHAR( TO_DATE(SJ.SALE_DT,'YYYYMMDD'), 'DY' )             AS WEEK_DAY       ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  COUNT( TO_CHAR( TO_DATE(SJ.SALE_DT,'YYYYMMDD'), 'DY' ) )    AS WEEK_DAY_CNT   ]'
        ...
        ||CHR(13)||CHR(10)||Q'[              GROUP  BY TO_CHAR( TO_DATE(SJ.SALE_DT,'YYYYMMDD'), 'DY' )   ]'
        ||CHR(13)||CHR(10)||Q'[         )   SJ                      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  (                           ]'
        ||CHR(13)||CHR(10)||Q'[             SELECT  TO_CHAR( TO_DATE(SP.SALE_DT,'YYYYMMDD'), 'DY' ) AS WEEK_DAY      ]'
        ...
        ||CHR(13)||CHR(10)||Q'[              GROUP  BY TO_CHAR( TO_DATE(SP.SALE_DT,'YYYYMMDD'), 'DY' )   ]'
        ||CHR(13)||CHR(10)||Q'[         )   SP                                  ]'
        ||CHR(13)||CHR(10)||Q'[  WHERE  SJ.WEEK_DAY   = SP.WEEK_DAY ]'
        ||CHR(13)||CHR(10)||Q'[  ORDER BY  CASE  WHEN SJ.WEEK_DAY = '월' THEN 1 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '화' THEN 2 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '수' THEN 3 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '목' THEN 4 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '금' THEN 5 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '토' THEN 6 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '일' THEN 7 ]'
        ||CHR(13)||CHR(10)||Q'[            END ]';
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  SJ.BRAND_CD     ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  SJ.STOR_CD      ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  TO_CHAR( TO_DATE(SJ.SALE_DT,'YYYYMMDD'), 'DY' )      ]'
        ||CHR(13)||CHR(10)||Q'[         )   SJ          ]'
        ||CHR(13)||CHR(10)||Q'[      ,  (               ]'
        ||CHR(13)||CHR(10)||Q'[             SELECT  SP.COMP_CD    ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  SP.BRAND_CD   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  SP.STOR_CD    ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  TO_CHAR( TO_DATE(SP.SALE_DT,'YYYYMMDD'), 'DY' )             AS WEEK_DAY     ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  NVL(SUM(DECODE(SP.PAY_DIV, '10', SP.PAY_AMT - (SP.CHANGE_AMT + SP.REMAIN_AMT))) ,0) AS PAY_10_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  NVL(SUM(DECODE(SP.PAY_DIV, '20', SP.PAY_AMT - (SP.CHANGE_AMT + SP.REMAIN_AMT))) ,0) AS PAY_20_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  NVL(SUM(DECODE(SP.PAY_DIV, '30', SP.PAY_AMT - (SP.CHANGE_AMT + SP.REMAIN_AMT))) ,0) AS PAY_30_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  NVL(SUM(DECODE(SP.PAY_DIV, '40', SP.PAY_AMT - (SP.CHANGE_AMT + SP.REMAIN_AMT))) ,0) AS PAY_40_AMT   ]'
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  SP.BRAND_CD   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  SP.STOR_CD    ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  TO_CHAR( TO_DATE(SP.SALE_DT,'YYYYMMDD'), 'DY' )      ]'
        ...
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.WEEK_DAY   = SP.WEEK_DAY ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.COMP_CD    = S.COMP_CD   ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.BRAND_CD   = S.BRAND_CD  ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.STOR_CD    = S.STOR_CD   ]'
        ||CHR(13)||CHR(10)||Q'[  ORDER BY S.STOR_NM,  CASE  WHEN SJ.WEEK_DAY = '월' THEN 1 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '화' THEN 2 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '수' THEN 3 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '목' THEN 4 ]'
        ||CHR(13)||CHR(10)||Q'[                  WHEN SJ.WEEK_DAY = '금' THEN 5 ]'
