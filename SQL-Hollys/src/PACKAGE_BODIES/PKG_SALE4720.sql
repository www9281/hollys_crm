--------------------------------------------------------
--  DDL for Package Body PKG_SALE4720
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4720" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||chr(13)||chr(10)||Q'[                                         ,  SUM(DECODE(:PSV_CUST_DIV, 'C', ETC_M_CNT + ETC_F_CNT, BILL_CNT - R_BILL_CNT)) AS TOT_CUST_CNT ]'
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[                       , SUM(DECODE(:PSV_CUST_DIV, 'C', ETC_M_CNT + ETC_F_CNT, BILL_CNT - R_BILL_CNT))   AS CUST_CNT   ]'
        ...
        ||CHR(13)||CHR(10)||Q'[                    FROM SALE_JTS S , S_STORE B                                                                        ]'
