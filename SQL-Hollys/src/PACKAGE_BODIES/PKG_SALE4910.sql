--------------------------------------------------------
--  DDL for Package Body PKG_SALE4910
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4910" AS
    ...
    IS
    /******************************************************************************
        NAME:       SP_TAB01    월별 TREND 매출현황(영업조직)
        PURPOSE:
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        /* 가로축 데이타 FETCH */
        ls_sql_tab_main := ''
        ||CHR(13)||CHR(10)||Q'[ SELECT  SJ.SALE_YM      ]'
        ||CHR(13)||CHR(10)||Q'[      ,  TO_CHAR(TO_DATE(SJ.SALE_YM, 'YYYYMM'), 'YYYY-MM')   AS SALE_YM_NM   ]'
        ||CHR(13)||CHR(10)||Q'[   FROM  SALE_JMS    SJ  ]'
        ...
        LOOP
            BEGIN
                ...
                V_HD1 := V_HD1 || CHR(13) || CHR(10) || Q'[      ,  ']' || qry_hd(i).SALE_YM_NM  || Q'[' AS CT]' || TO_CHAR(i*7 - 6);
                V_HD1 := V_HD1 || CHR(13) || CHR(10) || Q'[      ,  ']' || qry_hd(i).SALE_YM_NM  || Q'[' AS CT]' || TO_CHAR(i*7 - 5);
                V_HD1 := V_HD1 || CHR(13) || CHR(10) || Q'[      ,  ']' || qry_hd(i).SALE_YM_NM  || Q'[' AS CT]' || TO_CHAR(i*7 - 4);
                V_HD1 := V_HD1 || CHR(13) || CHR(10) || Q'[      ,  ']' || qry_hd(i).SALE_YM_NM  || Q'[' AS CT]' || TO_CHAR(i*7 - 3);
                V_HD1 := V_HD1 || CHR(13) || CHR(10) || Q'[      ,  ']' || qry_hd(i).SALE_YM_NM  || Q'[' AS CT]' || TO_CHAR(i*7 - 2);
                V_HD1 := V_HD1 || CHR(13) || CHR(10) || Q'[      ,  ']' || qry_hd(i).SALE_YM_NM  || Q'[' AS CT]' || TO_CHAR(i*7 - 1);
                V_HD1 := V_HD1 || CHR(13) || CHR(10) || Q'[      ,  ']' || qry_hd(i).SALE_YM_NM  || Q'[' AS CT]' || TO_CHAR(i*7);
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SJ.SALE_YM      AS SALE_YM  ]'
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  DECODE(SUM(SJ.BILL_CNT + SJ.R_BILL_CNT), 0, 0, SUM(DECODE(:PSV_FILTER, 'G', SJ.GRD_AMT, SJ.GRD_AMT - SJ.VAT_AMT)) / SUM(SJ.BILL_CNT + SJ.R_BILL_CNT))   AS BILL_AMT ]'
        ||CHR(13)||CHR(10)||Q'[   FROM  SALE_JMS    SJ  ]'
        ||CHR(13)||CHR(10)||Q'[      ,  S_STORE     S   ]'
        ||CHR(13)||CHR(10)||Q'[  WHERE  SJ.COMP_CD  = S.COMP_CD     ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SJ.BRAND_CD = S.BRAND_CD    ]'
        ...
        OPEN PR_RESULT FOR
            V_SQL USING PSV_FILTER, PSV_FILTER, PSV_FILTER, PSV_FILTER, PSV_COMP_CD, PSV_GFR_YM, PSV_GTO_YM;
    ...
    IS
    /******************************************************************************
        NAME:       SP_TAB02    월별 TREND 매출현황(부서)
        PURPOSE:
    ...
    ******************************************************************************/
    ...
    IS
    /******************************************************************************
        NAME:       SP_TAB04    월별 TREND 매출현황(영업담당자)
        PURPOSE:
    ...
    ******************************************************************************/
    ...
    IS
    /******************************************************************************
        NAME:       SP_TAB05    월별 TREND 매출현황(점포)
        PURPOSE:
    ...
    ******************************************************************************/
    ...
    IS
    /******************************************************************************
        NAME:       SP_TAB06    월별 TREND 매출현황(지역)
        PURPOSE:
    ...
    ******************************************************************************/
    ...
    IS
    /******************************************************************************
        NAME:       SP_TAB07    월별 TREND 매출현황(상권)
        PURPOSE:
