--------------------------------------------------------
--  DDL for Package Body PKG_SALE4060
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4060" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  SUM(DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT))    AS CUST_CNT_G   ]'
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  SUM(DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT))    AS CUST_CNT_D   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  MAX(C.SORT_SEQ)     AS SORT_SEQ     ]'
        ||CHR(13)||CHR(10)||q'[               FROM  SALE_JDS    SJ  ]'
        ||CHR(13)||CHR(10)||q'[                  ,  S_STORE     S   ]'
        ||CHR(13)||CHR(10)||Q'[                  ,  ]' || ls_sql_cm_00285 || Q'[ C ]'
