--------------------------------------------------------
--  DDL for Package Body PKG_SALE4450
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4450" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT)) AS CUST_CNT ]'  -- 매출 : 객수
        ||CHR(13)||CHR(10)||Q'[      ,  DECODE(SUM(DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT)), 0, 0, SUM(SJ.GRD_AMT) / SUM(DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT)))    AS CUST_AMT ]'  -- 매출 : 객단가
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT)) / (COUNT(DISTINCT SJ.STOR_CD) * COUNT(DISTINCT SJ.SALE_DT)) AS CUST_CNT_AVG ]'  -- 평균매출 : 평균객수
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN TO_CHAR(TO_DATE(SJ.SALE_DT, 'YYYYMMDD'), 'D') IN ('2', '3', '4', '5', '6') THEN DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT) ELSE 0 END)    AS DAY_CUST_CNT ]'  -- 매출 : 주중 객수
        ||CHR(13)||CHR(10)||Q'[      ,  DECODE(SUM(CASE WHEN TO_CHAR(TO_DATE(SJ.SALE_DT, 'YYYYMMDD'), 'D') IN ('2', '3', '4', '5', '6') THEN DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT) ELSE 0 END), 0, 0,  ]'
        ||CHR(13)||CHR(10)||Q'[           SUM(CASE WHEN TO_CHAR(TO_DATE(SJ.SALE_DT, 'YYYYMMDD'), 'D') IN ('2', '3', '4', '5', '6') THEN GRD_AMT  ELSE 0 END)  / ]'
        ||CHR(13)||CHR(10)||Q'[           SUM(CASE WHEN TO_CHAR(TO_DATE(SJ.SALE_DT, 'YYYYMMDD'), 'D') IN ('2', '3', '4', '5', '6') THEN DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT) ELSE 0 END)) AS DAY_CUST_AMT ]'  -- 매출 : 주중 객단가
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN TO_CHAR(TO_DATE(SJ.SALE_DT, 'YYYYMMDD'), 'D') IN ('1', '7') THEN DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT) ELSE 0 END)   AS WEEK_CUST_CNT    ]'  -- 주말 객수
        ||CHR(13)||CHR(10)||Q'[      ,  DECODE(SUM(CASE WHEN TO_CHAR(TO_DATE(SJ.SALE_DT, 'YYYYMMDD'), 'D') IN ('1', '7') THEN DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT) ELSE 0 END), 0, 0, ]'
        ||CHR(13)||CHR(10)||Q'[         SUM(CASE WHEN TO_CHAR(TO_DATE(SJ.SALE_DT, 'YYYYMMDD'), 'D') IN ('1', '7') THEN SJ.GRD_AMT ELSE 0 END) / ]'
        ||CHR(13)||CHR(10)||Q'[         SUM(CASE WHEN TO_CHAR(TO_DATE(SJ.SALE_DT, 'YYYYMMDD'), 'D') IN ('1', '7') THEN DECODE(:PSV_CUST_DIV, 'C', SJ.ETC_M_CNT + SJ.ETC_F_CNT, SJ.BILL_CNT - SJ.R_BILL_CNT) ELSE 0 END))  AS WEEK_CUST_AMT    ]'  -- 주말 객단가
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  SUM(SJ.R_BILL_CNT)      AS R_BILL_CNT]'
