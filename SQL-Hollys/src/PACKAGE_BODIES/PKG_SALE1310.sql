--------------------------------------------------------
--  DDL for Package Body PKG_SALE1310
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE1310" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  HU.DEPT_NM                  ]'
        ||CHR(13)||CHR(10)||Q'[      ,  HU.POSITION_CD              ]'
        ||CHR(13)||CHR(10)||Q'[      ,  HU.POSITION_NM              ]'
        ...
        ||CHR(13)||CHR(10)||Q'[  ORDER  BY HU.DEPT_CD, HU.USER_ID   ]'
        ;
        ls_sql := ls_sql_main;
        --dbms_output.put_line(ls_sql) ;

        OPEN PR_RESULT FOR
            ls_sql USING PSV_COMP_CD, PSV_LANG_CD, PSV_COMP_CD, PSV_DEPT_CD, PSV_DEPT_CD, PSV_USER_TXT, PSV_USER_TXT, PSV_USER_TXT, PSV_COMP_CD, PSV_YM;
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[    AND  SD.COMP_CD      = HU.COMP_CD        ]'
        ||CHR(13)||CHR(10)||Q'[    AND  SD.USER_ID      = HU.USER_ID        ]'
        ...
        OPEN PR_RESULT FOR
            ls_sql USING PSV_COMP_CD, PSV_LANG_CD, PSV_COMP_CD, PSV_LANG_CD, PSV_COMP_CD, PSV_LANG_CD, PSV_COMP_CD, PSV_DEPT_CD, PSV_DEPT_CD, PSV_USER_TXT, PSV_USER_TXT, PSV_USER_TXT, PSV_USER_ID, PSV_USER_ID, PSV_COMP_CD, PSV_DC_GRPCD, PSV_DC_GRPCD, PSV_GFR_DATE, PSV_GTO_DATE;
