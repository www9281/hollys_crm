--------------------------------------------------------
--  DDL for Package Body PKG_MNMG1020
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_MNMG1020" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  PUH.STOR_TP             ]'
        ||CHR(13)||CHR(10)||Q'[      ,  PUH.STOR_CD             ]'
        ||CHR(13)||CHR(10)||Q'[      ,  PUH.STOR_NM             ]'
        ...
        ||CHR(13)||CHR(10)||Q'[                     )   SU      ]'
        ||CHR(13)||CHR(10)||Q'[              WHERE  PUH.COMP_CD     = S.COMP_CD     ]'
        ||CHR(13)||CHR(10)||Q'[                AND  PUH.BRAND_CD    = S.BRAND_CD    ]'
        ||CHR(13)||CHR(10)||Q'[                AND  PUH.STOR_CD     = S.STOR_CD     ]'
        ||CHR(13)||CHR(10)||Q'[                AND  PUH.COMP_CD     = SU.COMP_CD    ]'
        ||CHR(13)||CHR(10)||Q'[                AND  PUH.BRAND_CD    = SU.BRAND_CD   ]'
        ||CHR(13)||CHR(10)||Q'[                AND  PUH.STOR_CD     = SU.STOR_CD    ]'
        ||CHR(13)||CHR(10)||Q'[                AND  PUH.USER_ID     = SU.USER_ID    ]'
