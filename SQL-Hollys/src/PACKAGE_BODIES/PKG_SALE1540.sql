--------------------------------------------------------
--  DDL for Package Body PKG_SALE1540
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE1540" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[       ,  S.STOR_NM       ]'
        ||CHR(13)||CHR(10)||Q'[       ,  SJ.SALE_DT      ]'
        ||CHR(13)||CHR(10)||Q'[   ORDER  BY S.STOR_NM, SJ.SALE_DT  ]';
    ...
    IS
    /******************************************************************************
        NAME:       SP_TAB02    머그컵 사용 일별 조회(매장별)
        PURPOSE:
