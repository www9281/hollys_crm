--------------------------------------------------------
--  DDL for Package Body PKG_SALE4510
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4510" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(SJ.R_BILL_CNT)      AS RTN_CNT  ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(SJ.R_SALE_QTY)      AS RTN_QTY  ]'
