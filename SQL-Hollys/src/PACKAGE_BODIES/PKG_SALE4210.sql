--------------------------------------------------------
--  DDL for Package Body PKG_SALE4210
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4210" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(V01.SALE_QTY) OVER(PARTITION BY V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD, V01.D_CLASS_CD, V01.ITEM_CD) AS TOT_SALE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(V01.SALE_AMT) OVER(PARTITION BY V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD, V01.D_CLASS_CD, V01.ITEM_CD) AS TOT_SALE_AMT ]'
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  V01.ITEM_CD     ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V01.ITEM_NM     ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(V01.SALE_QTY) OVER(PARTITION BY V01.BRAND_CD, V01.STOR_CD, V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD, V01.D_CLASS_CD, V01.ITEM_CD) AS TOT_SALE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(V01.SALE_AMT) OVER(PARTITION BY V01.BRAND_CD, V01.STOR_CD, V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD, V01.D_CLASS_CD, V01.ITEM_CD) AS TOT_SALE_AMT ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V01.SALE_DT     ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V01.SALE_QTY    ]'
        ||CHR(13)||CHR(10)||Q'[      ,  V01.SALE_AMT    ]'
        ||CHR(13)||CHR(10)||Q'[ FROM   (]'
        ...
        ||CHR(13)||CHR(10)||Q'[     )       ]'
        ||CHR(13)||CHR(10)||Q'[ )           ]'
        ||CHR(13)||CHR(10)||Q'[  ORDER  BY BRAND_CD, BRAND_NM, STOR_CD, STOR_NM, L_SORT_ORDER, L_CLASS_CD, M_SORT_ORDER, M_CLASS_CD, S_SORT_ORDER, S_CLASS_CD, D_SORT_ORDER, D_CLASS_CD, ITEM_CD ]';
