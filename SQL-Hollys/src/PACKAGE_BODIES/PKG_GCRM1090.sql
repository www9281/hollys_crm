--------------------------------------------------------
--  DDL for Package Body PKG_GCRM1090
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_GCRM1090" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        LOOP
            BEGIN
                ...
                ELSE
                    ...
                    V_HD1 := V_HD1 || CHR(13) || CHR(10) || Q'[      ,  ']' || FC_GET_WORDPACK(PSV_COMP_CD, PSV_LANG_CD, 'MEMBERSHIP') || Q'[' AS CT]';
                END IF;
                V_HD2 := V_HD2 || CHR(13) || CHR(10) || Q'[      ,  ']' || qry_hd(i).PROGRAM_NM  || Q'[' AS CT]' || TO_CHAR(i*2 - 1);
                V_HD2 := V_HD2 || CHR(13) || CHR(10) || Q'[      ,  ']' || FC_GET_WORDPACK(PSV_COMP_CD, PSV_LANG_CD, 'RATIO') || Q'[' AS CT]' || TO_CHAR(i*2);
            END;
        END LOOP;
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(SUM(SALE_AMT)) OVER (PARTITION BY COMP_CD, BRAND_CD, STOR_CD)   AS TOT_SALE_AMT ]'
        ||CHR(13)||CHR(10)||Q'[      ,  SUM(SUM(SALE_AMT)) OVER (PARTITION BY COMP_CD, BRAND_CD, STOR_CD)   AS COL_SALE_AMT ]'
        ...
        ||CHR(13)||CHR(10)||Q'[ (           ]'
        ||CHR(13)||CHR(10)||Q'[       SUM(SALE_AMT) AS COL1 ]'
        ||CHR(13)||CHR(10)||Q'[     , SUM(ROUND(SALE_AMT / COL_SALE_AMT * 100, 2))  AS COL2 ]'
