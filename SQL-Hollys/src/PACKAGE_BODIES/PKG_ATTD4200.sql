--------------------------------------------------------
--  DDL for Package Body PKG_ATTD4200
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_ATTD4200" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[ ,   (FLOOR (SUM(B1.WORK_TIME)) ) ||'시간'||' ' || LPAD(FLOOR (MOD( (SUM(B1.WORK_TIME) *60), 60) ), 2, 0) ||'분' AS WORK_HHMM    ]'
