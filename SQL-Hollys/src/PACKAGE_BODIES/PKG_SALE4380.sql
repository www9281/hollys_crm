--------------------------------------------------------
--  DDL for Package Body PKG_SALE4380
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4380" AS
    ...
    ( 
        ...
        PSV_CARD_CD     IN  VARCHAR2 ,                -- CARD 코드
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[      ,  NVL(L.LANG_NM, CL4.CODE_NM)  AS VAN_NM   ]'
        ...
        ||CHR(13)||CHR(10)||Q'[    AND  A.APPR_VAN_CD   = C.VAN_CD (+)   ]'
        ||CHR(13)||CHR(10)||Q'[    AND  C.COMP_CD       = CL4.COMP_CD(+) ]'
        ||CHR(13)||CHR(10)||Q'[    AND  C.VAN_CD        = CL4.CODE_CD(+) ]'
        ...
        ||CHR(13)||CHR(10)||Q'[    AND (:PSV_VAN_CD  IS NULL OR C.VAN_CD  = :PSV_VAN_CD) ]'
        ||CHR(13)||CHR(10)||Q'[    AND (:PSV_CARD_CD IS NULL OR C.CARD_CD = :PSV_CARD_CD) ]'
        ||CHR(13)||CHR(10)||Q'[  GROUP  BY A.APPR_MAEIP_CD, NVL(L.LANG_NM, C.CARD_NM) , NVL(L.LANG_NM, CL4.CODE_NM)         ]'
        ...
        OPEN PR_RESULT FOR
            ls_sql USING PSV_COMP_CD, PSV_LANG_CD, PSV_COMP_CD,  
                         PSV_GFR_DATE, PSV_GTO_DATE, PSV_VAN_CD, PSV_VAN_CD, PSV_CARD_CD, PSV_CARD_CD;
