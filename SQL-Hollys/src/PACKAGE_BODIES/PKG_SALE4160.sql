--------------------------------------------------------
--  DDL for Package Body PKG_SALE4160
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4160" AS
    ...
    */
        ...
        ls_sql_main := ''
            ...
            ||CHR(13)||CHR(10)||Q'[        SUM(DECODE(:PSV_FILTER, 'C', S.ETC_M_CNT + S.ETC_F_CNT, S.BILL_CNT - S.R_BILL_CNT)) AS CUST_CNT, ]' /*영수건수 -> 객수*/
            ||CHR(13)||CHR(10)||Q'[        ROUND(SUM(GRD_AMT) / DECODE(SUM(DECODE(:PSV_FILTER, 'C', S.ETC_M_CNT + S.ETC_F_CNT, S.BILL_CNT - S.R_BILL_CNT)),0,1,SUM(DECODE(:PSV_FILTER, 'C', S.ETC_M_CNT + S.ETC_F_CNT, S.BILL_CNT - S.R_BILL_CNT)))) AS CUST_AMT, ]' /*영수단가 -> 객단가 */
