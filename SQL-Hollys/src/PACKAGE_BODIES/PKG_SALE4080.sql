--------------------------------------------------------
--  DDL for Package Body PKG_SALE4080
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE4080" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  SUM(DECODE(:PSV_CUST_DIV, 'C', NVL(SJ.ETC_M_CNT, 0) + NVL(SJ.ETC_F_CNT, 0), NVL(SJ.BILL_CNT, 0) - NVL(SJ.R_BILL_CNT, 0))) AS G_CUST_CNT   ]'
        ...
        ||CHR(13)||CHR(10)||Q'[                  ,  SUM(DECODE(:PSV_CUST_DIV, 'C', NVL(SJ.ETC_M_CNT, 0) + NVL(SJ.ETC_F_CNT, 0), NVL(SJ.BILL_CNT, 0) - NVL(SJ.R_BILL_CNT, 0))) AS D_CUST_CNT   ]'
