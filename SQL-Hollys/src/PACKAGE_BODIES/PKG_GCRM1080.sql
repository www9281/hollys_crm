--------------------------------------------------------
--  DDL for Package Body PKG_GCRM1080
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_GCRM1080" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        IF (ls_sql_sms IS NOT NULL OR ls_sql_sms <> '') AND (ls_sql_mms IS NOT NULL OR ls_sql_mms <> '') THEN
            ...
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (SL.MSGKEY IS NOT NULL                                    ) OR (ST.TR_NUM IS NOT NULL                                       ) THEN 1 ELSE 0 END) AS SMS_SEND_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (SL.MSGKEY IS NOT NULL AND SL.RSLTSTAT = '00'             ) OR (ST.TR_NUM IS NOT NULL AND ST.TR_RSLTSTAT = '00'             ) THEN 1 ELSE 0 END) AS SMS_WAIT_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (SL.MSGKEY IS NOT NULL AND SL.RSLTSTAT NOT IN ('00', '06')) OR (ST.TR_NUM IS NOT NULL AND ST.TR_RSLTSTAT NOT IN ('00', '06')) THEN 1 ELSE 0 END) AS SMS_FAIL_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (SL.MSGKEY IS NOT NULL AND SL.RSLTSTAT = '06'             ) OR (ST.TR_NUM IS NOT NULL AND ST.TR_RSLTSTAT = '06'             ) THEN 1 ELSE 0 END) AS SMS_SUCCESS_CNT  ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ML.MSGKEY IS NOT NULL                                    ) OR (MM.MSGKEY IS NOT NULL                                       ) THEN 1 ELSE 0 END) AS MMS_SEND_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ML.MSGKEY IS NOT NULL AND ML.RSLTSTAT IS NULL            ) OR (MM.MSGKEY IS NOT NULL AND MM.RSLT IS NULL                   ) THEN 1 ELSE 0 END) AS MMS_WAIT_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ML.MSGKEY IS NOT NULL AND ML.RSLTSTAT <> '1000'          ) OR (MM.MSGKEY IS NOT NULL AND MM.RSLT <> '1000'                 ) THEN 1 ELSE 0 END) AS MMS_FAIL_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ML.MSGKEY IS NOT NULL AND ML.RSLTSTAT =  '1000'          ) OR (MM.MSGKEY IS NOT NULL AND MM.RSLT =  '1000'                 ) THEN 1 ELSE 0 END) AS MMS_SUCCESS_CNT  ]'
            ...
            ||CHR(13)||CHR(10)||Q'[  WHERE  CS.MSGKEY       = SL.MSGKEY(+)  ]'
        ...
        ELSIF (ls_sql_sms IS NOT NULL OR ls_sql_sms <> '') AND (ls_sql_mms IS NULL OR ls_sql_mms = '') THEN
            ...
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (SL.MSGKEY IS NOT NULL AND SL.RSLTSTAT NOT IN ('00', '06')) OR (ST.TR_NUM IS NOT NULL AND ST.TR_RSLTSTAT NOT IN ('00', '06')) THEN 1 ELSE 0 END) AS SMS_FAIL_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (SL.MSGKEY IS NOT NULL AND SL.RSLTSTAT = '06'             ) OR (ST.TR_NUM IS NOT NULL AND ST.TR_RSLTSTAT = '06'             ) THEN 1 ELSE 0 END) AS SMS_SUCCESS_CNT  ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (MM.MSGKEY IS NOT NULL                                    ) THEN 1 ELSE 0 END) AS MMS_SEND_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (MM.MSGKEY IS NOT NULL AND MM.RSLT IS NULL                ) THEN 1 ELSE 0 END) AS MMS_WAIT_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (MM.MSGKEY IS NOT NULL AND MM.RSLT <> '1000'              ) THEN 1 ELSE 0 END) AS MMS_FAIL_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (MM.MSGKEY IS NOT NULL AND MM.RSLT =  '1000'              ) THEN 1 ELSE 0 END) AS MMS_SUCCESS_CNT  ]'
            ||CHR(13)||CHR(10)||Q'[   FROM  CS_CONTENT_SEND     CS  ]'
            ||CHR(13)||CHR(10)||Q'[      ,  S_STORE             S   ]'
            ||CHR(13)||CHR(10)||Q'[      ,  (                       ]'
            ||CHR(13)||CHR(10)||Q'[             ]' || ls_sql_sms
        ...
        ELSIF (ls_sql_sms IS NULL OR ls_sql_sms = '') AND (ls_sql_mms IS NOT NULL OR ls_sql_mms <> '') THEN
            ...
            ls_sql_main := ''
            ||CHR(13)||CHR(10)||Q'[ SELECT  S.BRAND_CLASS                           ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ST.TR_NUM IS NOT NULL                                       ) THEN 1 ELSE 0 END) AS SMS_SEND_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ST.TR_NUM IS NOT NULL AND ST.TR_RSLTSTAT = '00'             ) THEN 1 ELSE 0 END) AS SMS_WAIT_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ST.TR_NUM IS NOT NULL AND ST.TR_RSLTSTAT NOT IN ('00', '06')) THEN 1 ELSE 0 END) AS SMS_FAIL_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ST.TR_NUM IS NOT NULL AND ST.TR_RSLTSTAT = '06'             ) THEN 1 ELSE 0 END) AS SMS_SUCCESS_CNT  ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ML.MSGKEY IS NOT NULL                                       ) OR (MM.MSGKEY IS NOT NULL                      ) THEN 1 ELSE 0 END) AS MMS_SEND_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ML.MSGKEY IS NOT NULL AND ML.RSLTSTAT IS NULL               ) OR (MM.MSGKEY IS NOT NULL AND MM.RSLT IS NULL  ) THEN 1 ELSE 0 END) AS MMS_WAIT_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ML.MSGKEY IS NOT NULL AND ML.RSLTSTAT <> '1000'             ) OR (MM.MSGKEY IS NOT NULL AND MM.RSLT <> '1000') THEN 1 ELSE 0 END) AS MMS_FAIL_CNT     ]'
            ||CHR(13)||CHR(10)||Q'[      ,  SUM(CASE WHEN (ML.MSGKEY IS NOT NULL AND ML.RSLTSTAT =  '1000'             ) OR (MM.MSGKEY IS NOT NULL AND MM.RSLT =  '1000') THEN 1 ELSE 0 END) AS MMS_SUCCESS_CNT  ]'
            ...
            ||CHR(13)||CHR(10)||Q'[      ,  SC_TRAN             ST  ]'
            ||CHR(13)||CHR(10)||Q'[      ,  MMS_MSG             MM  ]'
            ||CHR(13)||CHR(10)||Q'[  WHERE  CS.MSGKEY       = ML.MSGKEY(+)  ]'
            ||CHR(13)||CHR(10)||Q'[    AND  CS.MSGKEY       = ST.TR_NUM(+)  ]'
            ||CHR(13)||CHR(10)||Q'[    AND  CS.MSGKEY       = MM.MSGKEY(+)  ]'
            ||CHR(13)||CHR(10)||Q'[    AND  CS.COMP_CD      = S.COMP_CD     ]'
            ||CHR(13)||CHR(10)||Q'[    AND  CS.BRAND_CD     = S.BRAND_CD    ]'
        ...
        ELSIF (ls_sql_sms IS NULL OR ls_sql_sms = '') AND (ls_sql_mms IS NULL OR ls_sql_mms = '') THEN
            ...
            ||CHR(13)||CHR(10)||Q'[      ,  SC_TRAN             ST  ]'
            ||CHR(13)||CHR(10)||Q'[      ,  MMS_MSG             MM  ]'
            ||CHR(13)||CHR(10)||Q'[  WHERE  CS.MSGKEY       = ST.TR_NUM(+)  ]'
            ||CHR(13)||CHR(10)||Q'[    AND  CS.MSGKEY       = MM.MSGKEY(+)  ]'
            ||CHR(13)||CHR(10)||Q'[    AND  CS.COMP_CD      = S.COMP_CD     ]'
            ||CHR(13)||CHR(10)||Q'[    AND  CS.BRAND_CD     = S.BRAND_CD    ]'
            ||CHR(13)||CHR(10)||Q'[    AND  CS.STOR_CD      = S.STOR_CD     ]'
