--------------------------------------------------------
--  DDL for Package Body PKG_SALE1350
--------------------------------------------------------

  CREATE OR REPLACE PACKAGE BODY "CRMDEV"."PKG_SALE1350" AS
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[       , D1.SALE_QTY         AS D1_SALE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[       , D1.FREE_QTY         AS D1_FREE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[       , D1.SALE_AMT         AS D1_SALE_AMT ]'
        ||CHR(13)||CHR(10)||Q'[       , D1.DC_AMT           AS D1_DC_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[       , D1.GRD_AMT          AS D1_GRD_AMT  ]'
        ||CHR(13)||CHR(10)||Q'[       , D1.NET_AMT          AS D1_NET_AMT  ]'
        ||CHR(13)||CHR(10)||Q'[       , D1.VAT_AMT          AS D1_VAT_AMT  ]'
        ||CHR(13)||CHR(10)||Q'[       , D1.DC_QTY           AS D1_DC_QTY   ]'
        ||CHR(13)||CHR(10)||Q'[       , MAX(D1.DAY_CNT) OVER(PARTITION BY D1.COMP_CD, D1.BRAND_CD, D1.STOR_CD) AS D1_DAY_CNT  ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.SALE_QTY, 0) AS D2_SALE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.FREE_QTY, 0) AS D2_FREE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.SALE_AMT, 0) AS D2_SALE_AMT ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.DC_AMT  , 0) AS D2_DC_AMT   ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.GRD_AMT , 0) AS D2_GRD_AMT  ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.NET_AMT , 0) AS D2_NET_AMT  ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.VAT_AMT , 0) AS D2_VAT_AMT  ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.DC_QTY  , 0) AS D2_DC_QTY   ]'
        ||CHR(13)||CHR(10)||Q'[       , MAX(NVL(D2.DAY_CNT , 0)) OVER(PARTITION BY D1.COMP_CD, D1.BRAND_CD, D1.STOR_CD) AS D2_DAY_CNT  ]'
        ...
        ||CHR(13)||CHR(10)||Q'[ AND     D1.COMP_CD  = D2.COMP_CD (+)]'
        ||CHR(13)||CHR(10)||Q'[ AND     D1.BRAND_CD = D2.BRAND_CD(+)]'
        ||CHR(13)||CHR(10)||Q'[ AND     D1.STOR_CD  = D2.STOR_CD (+)]'
        ||CHR(13)||CHR(10)||Q'[ AND     D1.ITEM_CD  = D2.ITEM_CD (+)]'
        ...
        OPEN PR_RESULT FOR
            ls_sql USING  PSV_COMP_CD , PSV_GFR_DATE, PSV_GTO_DATE
                        , PSV_COMP_CD , PSV_DFR_DATE, PSV_DTO_DATE;
    ...
    ******************************************************************************/
    ...
    BEGIN
        ...
        ||CHR(13)||CHR(10)||Q'[       , D1.VAT_AMT          AS D1_VAT_AMT  ]'
        ||CHR(13)||CHR(10)||Q'[       , D1.DC_QTY           AS D1_DC_QTY   ]'
        ||CHR(13)||CHR(10)||Q'[       , MAX(D1.STOR_CNT) OVER(PARTITION BY D1.COMP_CD, D1.BRAND_CD) AS D1_STOR_CNT ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.SALE_QTY, 0) AS D2_SALE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.FREE_QTY, 0) AS D2_FREE_QTY ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.SALE_AMT, 0) AS D2_SALE_AMT ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.DC_AMT  , 0) AS D2_DC_AMT   ]'
        ...
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.VAT_AMT , 0) AS D2_VAT_AMT  ]'
        ||CHR(13)||CHR(10)||Q'[       , NVL(D2.DC_QTY  , 0) AS D2_DC_QTY   ]'
        ||CHR(13)||CHR(10)||Q'[       , MAX(NVL(D2.STOR_CNT, 0)) OVER(PARTITION BY D1.COMP_CD, D1.BRAND_CD) AS D2_STOR_CNT ]'
