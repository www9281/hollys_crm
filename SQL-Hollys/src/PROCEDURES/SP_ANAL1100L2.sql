--------------------------------------------------------
--  DDL for Procedure SP_ANAL1100L2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_ANAL1100L2" /*원가시뮬레이션(메뉴-가상원가)*/
(   
  ...
  PSV_STD_YM      IN  VARCHAR2 ,                -- 조회 기준년월
  PSV_RCP_VER     IN  VARCHAR2 ,                -- 레시피 기준 Version
...
*/ 
    ...
    *******************************************************************************/           
    ...
    ls_sql_main :=
        ...
        || chr(13)||chr(10) ||  '           V1.P_ITEM_COST                      P_ITEM_COST,            '
        ...
        || chr(13)||chr(10) ||  '                   ICS.RUN_QTY * VER.DO_COST   P_ITEM_AMT,             '
        || chr(13)||chr(10) ||  '                   VER.DO_COST                 P_ITEM_COST,            '
        ...
        || chr(13)||chr(10) ||  '                           STOR_TP,                                    '
        || chr(13)||chr(10) ||  '                           P_ITEM_CD,                                  '
        || chr(13)||chr(10) ||  '                           SUM(DO_COST) DO_COST                        '
        || chr(13)||chr(10) ||  '                   FROM    TABLE(FN_ALAL1090F0('''||PSV_COMP_CD||''','''||PSV_STD_YM||''','''||PSV_RCP_VER||''','''||PSV_MENU_VER||'''))'
        ...
        || chr(13)||chr(10) ||  '           AND     STR.COMP_CD  = VER.COMP_CD                          '
        || chr(13)||chr(10) ||  '           AND     STR.BRAND_CD = VER.BRAND_CD                         '
        || chr(13)||chr(10) ||  '           AND     STR.STOR_TP  = VER.STOR_TP                          '
        || chr(13)||chr(10) ||  '           AND     ICS.ITEM_CD  = VER.P_ITEM_CD                        '
