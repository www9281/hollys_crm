...
BEGIN
    ...
    IF PSV_CARD_STAT = '90' AND nREC_CNT > 0 AND vREP_CARD_YN = 'Y' THEN 
        UPDATE  C_CARD
        SET     REP_CARD_YN = 'Y'
        WHERE   COMP_CD = PSV_COMP_CD
        AND     CARD_ID = (
