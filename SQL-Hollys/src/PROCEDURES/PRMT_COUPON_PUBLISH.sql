--------------------------------------------------------
--  DDL for Procedure PRMT_COUPON_PUBLISH
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."PRMT_COUPON_PUBLISH" (
-- ==========================================================================================
-- Author        :    권혁민
                 ...
                 BEGIN    
                         ...
                         LOOP
                                ...
                                LOOP
                                    ...
                                    v_random_cd := '3'|| SUBSTR(TO_CHAR(SYSDATE,'YYMMDDHH24MM'), 2, 10) ||  LPAD(TO_CHAR(COUPON_SEQ.NEXTVAL), 8, '0')|| LPAD(TO_CHAR(ROUND(DBMS_RANDOM.VALUE(1,10)*10)), 2,'0')
                                    ;
