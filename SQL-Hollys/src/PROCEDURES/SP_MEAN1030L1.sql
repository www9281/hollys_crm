--------------------------------------------------------
--  DDL for Procedure SP_MEAN1030L1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEAN1030L1" /* 회원통계정보-회원현황(점포) */
(
...
IS
/******************************************************************************
   NAME:       SP_MEAN1030L1      회원통계정보-연령대회원현황(점포)
   PURPOSE:
...
*/
    ...
    ls_sql_main :=                  '   SELECT  MSS.STOR_CD                '
                ...
                ||chr(13)||chr(10)||'                 , SUM(MSS.BILL_CNT) CST_BILL_CNT             '
                ||chr(13)||chr(10)||'                 , SUM(MSS.SALE_QTY) CST_SALE_QTY             '
                ||chr(13)||chr(10)||'                 , SUM(MSS.GRD_AMT ) CST_GRD_AMT              '
                ||chr(13)||chr(10)||'           FROM   (                                           '
                ||chr(13)||chr(10)||'                   SELECT  MSS.COMP_CD                        '
                ||chr(13)||chr(10)||'                         , MSS.BRAND_CD                       '
                ||chr(13)||chr(10)||'                         , MSS.STOR_CD                        '
                ...
                ||chr(13)||chr(10)||'                         , ROW_NUMBER() OVER(PARTITION BY MSS.COMP_CD, MSS.CUST_ID, MSS.CUST_LVL ORDER BY MSS.SALE_YM) R_NUM '
                ...
                ||chr(13)||chr(10)||'   AND     MSS.COMP_CD  = LVL.COMP_CD                         '
                ||chr(13)||chr(10)||'   AND     MSS.CUST_LVL = LVL.LVL_CD                          '
                ||chr(13)||chr(10)||'   ORDER BY MSS.STOR_CD, MSS.SALE_YM, LVL.LVL_RANK            '
        ;
