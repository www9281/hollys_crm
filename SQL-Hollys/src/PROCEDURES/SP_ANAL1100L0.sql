--------------------------------------------------------
--  DDL for Procedure SP_ANAL1100L0
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_ANAL1100L0" /*원가시뮬레이션(메뉴-표준단가)*/
(   
...
IS       
/******************************************************************************
   NAME:       SP_ANAL1100L0 원가시뮬레이션(메뉴-표준단가)
   PURPOSE:    
...
*/ 
    ...
    *******************************************************************************/           
    ...
    ls_sql_main :=
        ...
        || chr(13)||chr(10) ||  '                   ICS.STD_QTY         P_ITEM_QTY,                     '
        || chr(13)||chr(10) ||  '                   ICS.STD_AMT         P_ITEM_AMT,                     '
        || chr(13)||chr(10) ||  '                   ICS.STD_COST        P_ITME_COST,                    '
