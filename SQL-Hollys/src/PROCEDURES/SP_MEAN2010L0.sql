--------------------------------------------------------
--  DDL for Procedure SP_MEAN2010L0
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEAN2010L0" /* 연령대/상품분류별 구매분석 */
(
...
*/
    ...
    ls_sql_main :=                  '   SELECT  V02.COMP_CD         '
                ...
                ||chr(13)||chr(10)||'                 , SUM(V01.SALE_QTY) OVER(PARTITION BY V01.COMP_CD, V01.AGE_GRP, V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD) CLS_SUM_QTY  '
                ||chr(13)||chr(10)||'                 , SUM(V01.GRD_AMT ) OVER(PARTITION BY V01.COMP_CD, V01.AGE_GRP, V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD) CLS_SUM_GRD  '
                ||chr(13)||chr(10)||'                 , SUM(V01.GRD_AMT ) OVER(PARTITION BY V01.COMP_CD, V01.AGE_GRP                                                ) AGE_SUM_GRD  '
                ||chr(13)||chr(10)||'                 , ROW_NUMBER()      OVER(PARTITION BY V01.COMP_CD, V01.AGE_GRP, V01.L_CLASS_CD, V01.M_CLASS_CD, V01.S_CLASS_CD ORDER BY GRD_AMT DESC) R_NUM  '
                ||chr(13)||chr(10)||'           FROM   (               '
