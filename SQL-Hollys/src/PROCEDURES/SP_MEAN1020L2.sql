--------------------------------------------------------
--  DDL for Procedure SP_MEAN1020L2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEAN1020L2" /* 회원통계정보-연령대회원현황(회원) */
(
...
IS
/******************************************************************************
   NAME:       SP_MEAN1010L2     회원통계정보-연령대회원현황(회원)
   PURPOSE:
...
*/
    ...
    ls_sql_main :=                  '   SELECT  TOT.COMP_CD                '
                ...
                ||chr(13)||chr(10)||'                   WHERE   ST.COMP_CD  = MS.COMP_CD          '
                ||chr(13)||chr(10)||'                   AND     ST.BRAND_CD = MS.BRAND_CD '        
                ...
                ||chr(13)||chr(10)||'   AND     TOT.COMP_CD  = V03.COMP_CD                         '
                ||chr(13)||chr(10)||'   AND     TOT.CUST_AGE  BETWEEN V03.VAL_N1 AND V03.VAL_N2    '
                ...
                ||chr(13)||chr(10)||'   ORDER BY TOT.COMP_CD, TOT.STOR_CD, TOT.SALE_YM, V03.CODE_CD,  TOT.CUST_ID, TOT.ITEM_CD        '
        ;
