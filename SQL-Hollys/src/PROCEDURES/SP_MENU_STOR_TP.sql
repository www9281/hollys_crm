--------------------------------------------------------
--  DDL for Procedure SP_MENU_STOR_TP
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MENU_STOR_TP" 
/******************************************************************************
   NAME     :  SP_MENU_STOR_TP
...
BEGIN
     ...
     IF( p_proc_fg = 'S' ) THEN
          BEGIN
               ...
               INSERT INTO W_MENU_STOR_TP (COMP_CD, STOR_TP , MENU_CD ,AUTHORITY, USE_YN , INST_DT , INST_USER , UPD_DT ,UPD_USER)
               VALUES(p_comp_cd, p_stor_tp , p_menu_cd , '' , 'Y' , sysdate, p_user_id ,sysdate , p_user_id);
               ...
               if( s_menu_user_ref = 0  AND s_menu_ref <> 0 ) THEN
                    SP_MENU_STOR_TP(p_comp_cd, p_stor_tp ,  s_menu_ref , 'S' , p_user_id , liv_msg_code , liv_msg_code );
               END IF;
          END;
