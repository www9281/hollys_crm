--------------------------------------------------------
--  DDL for Procedure C_CUST_STORE_MENU_ANALYZE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."C_CUST_STORE_MENU_ANALYZE" (
        ...
        FROM    STORE ST  
              ...
              ,(            
                SELECT                                
                     ...
                     ,  COUNT(DISTINCT SJ.SALE_DT)   AS DAY_CNT 
                FROM    SALE_JDM   SJ                           
                     ,  STORE    SS                           
                WHERE   1 = 1                 
