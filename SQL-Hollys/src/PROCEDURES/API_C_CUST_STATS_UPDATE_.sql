--------------------------------------------------------
--  DDL for Procedure API_C_CUST_STATS_UPDATE_
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."API_C_CUST_STATS_UPDATE_" (
...
BEGIN  
      ...
      dbms_output.put_line( '--------->'||v_result_cd );
      
EXCEPTION
    WHEN OTHERS THEN
        O_RTN_CD  := '110';
END API_C_CUST_STATS_UPDATE_;
