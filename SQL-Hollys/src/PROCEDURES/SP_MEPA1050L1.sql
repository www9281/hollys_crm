--------------------------------------------------------
--  DDL for Procedure SP_MEPA1050L1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEPA1050L1" /* 회원 크라운 적립현황(연령대) */
(
...
IS
/******************************************************************************
   NAME:       SP_MEPA1050L1  회원 크라운 적립현황(연령대) 
   PURPOSE:
