--------------------------------------------------------
--  DDL for Procedure SP_MEAN1060L0
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEAN1060L0" /* 회원육성관점- 가동율 */
(
...
*/
    ...
    ls_sql_main :=                  '   SELECT  /*+ NO_MERGE LEADING(CST) */ '
                ...
                ||chr(13)||chr(10)||'         , JDS.TOT_GRD_AMT - MSS.CST_GRD_AMT AS TOT_GRD_AMT        '
                ||chr(13)||chr(10)||'         , CASE WHEN JDS.TOT_GRD_AMT  = 0 THEN 0 ELSE ROUND(MSS.CST_GRD_AMT  / JDS.TOT_GRD_AMT  *100, 2)  END AS CST_SALE_RATE '
                ||chr(13)||chr(10)||'   FROM   (                                                        '
                ||chr(13)||chr(10)||'           SELECT  /*+ NO_MERGE */                                 '
                ||chr(13)||chr(10)||'                   COMP_CD                                         '
                ||chr(13)||chr(10)||'                 , SALE_YM                                         '
                ||chr(13)||chr(10)||'                 , COUNT(*) AS TOT_CUST_CNT                        '
                ||chr(13)||chr(10)||'           FROM    C_CUST_MLVL MVL                                    '
                ||chr(13)||chr(10)||'           WHERE   COMP_CD  = '''||PSV_COMP_CD   ||'''             '
                ||chr(13)||chr(10)||'           AND     SALE_YM >= '''||PSV_STR_YM   ||'''              '
                ||chr(13)||chr(10)||'           AND     SALE_YM <= '''||PSV_END_YM   ||'''              '
                ||chr(13)||chr(10)||'           AND    ('''||PSV_CUST_GRADE||''' IS NULL OR CUST_LVL = '''||PSV_CUST_GRADE||''')'
                ...
                ||chr(13)||chr(10)||'                           AND     SUBSTR(NVL(CST.LEAVE_DT,''99991231''), 1, 8) >= MVL.SALE_YM||''31'''
                ||chr(13)||chr(10)||'                          )                                        '
                ||chr(13)||chr(10)||'           GROUP BY COMP_CD, SALE_YM                               '
                ||chr(13)||chr(10)||'          ) CST                                                    '
                ||chr(13)||chr(10)||'         ,(                                                        '
                ...
                ||chr(13)||chr(10)||'                   '''||PSV_COMP_CD||'''       AS COMP_CD     '
                ...
                ||chr(13)||chr(10)||'   AND     CST.SALE_YM   = JDS.SALE_YM                        '
                ||chr(13)||chr(10)||'   ORDER BY CST.SALE_YM                                       '
        ;
