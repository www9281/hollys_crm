--------------------------------------------------------
--  DDL for Procedure C_CUST_MSG_HIS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."C_CUST_MSG_HIS" /* 회원정보관리 MMS 전송이력 */
(
  P_PSV_PHONE       IN    VARCHAR2,                -- 휴대전화번호
  O_PR_RESULT       OUT   SYS_REFCURSOR,           -- Result Set
  O_PR_RTN_CD       OUT   VARCHAR2,                -- 처리코드
  O_PR_RTN_MSG      OUT   VARCHAR2                 -- 처리Message
)
IS
/******************************************************************************
   NAME:       C_CUST_MSG_HIS      회원정보관리 MMS 전송이력
   PURPOSE:
