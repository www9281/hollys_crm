--------------------------------------------------------
--  DDL for Procedure SP_MEPA1010L2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEPA1010L2" /* 회원 포인트 적립현황(회원등급) */
(
...
IS
/******************************************************************************
   NAME:       SP_MEPA1010L2  회원 포인트 적립현황(회원등급) 
   PURPOSE:
