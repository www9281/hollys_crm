--------------------------------------------------------
--  DDL for Procedure SP_MEAN2050L0
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEAN2050L0" /* 회원 VS 비회원 분석 */
(
...
IS
/******************************************************************************
   NAME:       SP_MEAN2050L0  회원 VS 비회원 분석
   PURPOSE:
...
*/
    ...
    */
    ...
    ls_sql_main :=                  '   SELECT  JDS.SALE_YM          AS SALE_YM     '
                ...
                ||chr(13)||chr(10)||'                           FROM   (                                            '
                ||chr(13)||chr(10)||'                                   SELECT  MMS.SALE_YM                         '
                ||chr(13)||chr(10)||'                                         , MMS.CUST_ID                         '
                ||chr(13)||chr(10)||'                                         , ROW_NUMBER() OVER(PARTITION BY MMS.SALE_YM, MMS.CUST_ID ORDER BY MMS.CUST_LVL) R_NUM '      
                ||chr(13)||chr(10)||'                                   FROM    C_CUST_MSS MMS                      '
                ||chr(13)||chr(10)||'                                         , S_STORE    STO                      '        
                ||chr(13)||chr(10)||'                                   WHERE   STO.COMP_CD  = MMS.COMP_CD          '
                ||chr(13)||chr(10)||'                                   AND     STO.BRAND_CD = MMS.BRAND_CD         '
                ||chr(13)||chr(10)||'                                   AND     STO.STOR_CD  = MMS.STOR_CD          '
