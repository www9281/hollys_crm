--------------------------------------------------------
--  DDL for Procedure SP_MEAN1030L0
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEAN1030L0" /* 회원통계정보-회원등급별현황(전체) */
(
...
IS
/******************************************************************************
   NAME:       SP_MEAN1030L0      회원통계정보-회원등급별현황(전체)
   PURPOSE:
...
*/
    ...
    ls_sql_main :=                  '   SELECT  MSC.CUST_LVL               '
                ||chr(13)||chr(10)||'         , MSC.LVL_NM                 '
                ||chr(13)||chr(10)||'         , MSC.TOT_CUST_CNT           '
                ||chr(13)||chr(10)||'         , MSS.CST_CUST_CNT           '
                ||chr(13)||chr(10)||'         , CASE WHEN MSC.TOT_CUST_CNT = 0 THEN 0 ELSE ROUND(MSS.CST_CUST_CNT / MSC.TOT_CUST_CNT * 100, 2) END AS OPER_RATE     '
                ...
                ||chr(13)||chr(10)||'   FROM   (                           '    
                ||chr(13)||chr(10)||'           SELECT  MSC.COMP_CD                        '
                ||chr(13)||chr(10)||'                 , MSC.CUST_LVL                       '
                ||chr(13)||chr(10)||'                 , LVL.LVL_NM                         '
                ||chr(13)||chr(10)||'                 , LVL.LVL_RANK                       '
                ||chr(13)||chr(10)||'                 , SUM(MSC.CUST_CNT) AS TOT_CUST_CNT   ' -- 레벨 진입 회원수
                ||chr(13)||chr(10)||'           FROM    C_CUST_MSC MSC                     '
                ||chr(13)||chr(10)||'                 , C_CUST_LVL LVL                     '
                ||chr(13)||chr(10)||'           WHERE   MSC.COMP_CD  = LVL.COMP_CD         '
                ||chr(13)||chr(10)||'           AND     MSC.CUST_LVL = LVL.LVL_CD          '
                ||chr(13)||chr(10)||'           AND     MSC.COMP_CD  = '''||PSV_COMP_CD  ||''''
                --||chr(13)||chr(10)||'           AND     MSC.SALE_YM >= '''||PSV_STR_YM   ||''''
                ||chr(13)||chr(10)||'           AND     MSC.SALE_YM  = '''||PSV_END_YM   ||''''
                ||chr(13)||chr(10)||'           GROUP BY                                           '
                ||chr(13)||chr(10)||'                   MSC.COMP_CD                                '
                ||chr(13)||chr(10)||'                 , MSC.CUST_LVL                               '
                ||chr(13)||chr(10)||'                 , LVL.LVL_NM                                 '
                ||chr(13)||chr(10)||'                 , LVL.LVL_RANK                               '
                ||chr(13)||chr(10)||'          ) MSC                                               '
                ...
                ||chr(13)||chr(10)||'                         , ROW_NUMBER() OVER(PARTITION BY MSS.COMP_CD, MSS.CUST_ID ORDER BY MSS.SALE_YM DESC, MSS.CUST_LVL DESC) R_NUM '
                ...
                ||chr(13)||chr(10)||'                 , MSS.CUST_LVL                               '
                ||chr(13)||chr(10)||'          ) MSS                                               '
                ||chr(13)||chr(10)||'   WHERE   MSC.COMP_CD  = MSS.COMP_CD (+)                      '
                ||chr(13)||chr(10)||'   AND     MSC.CUST_LVL = MSS.CUST_LVL(+)                      '
                ||chr(13)||chr(10)||'   ORDER BY MSC.LVL_RANK                                      '
        ;
