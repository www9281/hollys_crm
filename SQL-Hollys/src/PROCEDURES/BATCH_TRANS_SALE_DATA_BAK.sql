--------------------------------------------------------
--  DDL for Procedure BATCH_TRANS_SALE_DATA_BAK
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."BATCH_TRANS_SALE_DATA_BAK" 
IS 
    v_hd_date DATE;
    v_dt_date DATE;
    v_st_date DATE;
    ...
    BEGIN
             ...
             WHEN NOT MATCHED THEN    
                    INSERT  VALUES (
                          ...
                          , FR.VAT_O_AMT, FR.SVC_AMT, FR.SVC_DC_AMT, FR.SVC_VAT_AMT, FR.CREDIT_AMT, FR.PACK_AMT, FR.SALER_DT, FR.SAP_IF_YN, FR.SAP_IF_DT, FR.SALE_TYPE, FR.CNT_ORD_NO, FR.SAV_MLG, FR.SAV_PT, FR.CUST_ID, FR.CARD_ID, FR.CUST_NM, FR.INST_DT, 'N'
                    );
    ...
    BEGIN
             ...
             WHEN NOT MATCHED THEN    
                     INSERT  VALUES (
                          ...
                          , FR.GRD_AMT, FR.NET_AMT, FR.VAT_RATE, FR.VAT_AMT, FR.SVC_RATE, FR.SVC_AMT, FR.SVC_VAT_AMT, FR.SALER_DT, FR.SALE_TYPE, FR.RTN_DIV, FR.USER_ID, FR.CUST_ID, FR.CARD_ID, FR.SAV_MLG, FR.SAV_PT, FR.DC_QTY, FR.FREE_QTY, FR.INST_DT, 'N'
                    );
    ...
    -----------------------------------------  SALE_ST ------------------------------------------
             ...
             WHEN NOT MATCHED THEN    
                    INSERT  VALUES (
                          ...
                          , FR.APPR_QTY, FR.SALER_DT, FR.SALE_TYPE, FR.CUST_ID, FR.CARD_ID, FR.SALE_TM, FR.INST_DT, 'N'
                    );
    ...
    -----------------------------------------  SALE_DC ------------------------------------------
             ...
             WHEN MATCHED THEN    
                     UPDATE SET 
                          ...
                          , T.ORG_AUTH_NO    =   FR.ORG_AUTH_NO
                          , T.ORG_AUTH_DT    =   FR.ORG_AUTH_DT
             WHEN NOT MATCHED THEN    
                    INSERT  VALUES ( 
                            FR.COMP_CD
                          , FR.SALE_DT
                          ...
                          , FR.ORG_AUTH_NO, FR.ORG_AUTH_DT, 'N'
                    );
