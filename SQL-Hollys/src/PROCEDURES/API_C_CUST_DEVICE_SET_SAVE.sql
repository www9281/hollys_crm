--------------------------------------------------------
--  DDL for Procedure API_C_CUST_DEVICE_SET_SAVE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."API_C_CUST_DEVICE_SET_SAVE" (
    P_CUST_ID   IN  VARCHAR2,
    P_DIV_NM    IN  VARCHAR2,
    P_DIV_YN    IN  VARCHAR2,
...
END API_C_CUST_DEVICE_SET_SAVE;
