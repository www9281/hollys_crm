--------------------------------------------------------
--  DDL for Procedure SP_MEAN1030L2
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEAN1030L2" /* 회원통계정보-등급별회원현황(회원) */
(
...
IS
/******************************************************************************
   NAME:       SP_MEAN1010L2     회원통계정보-등급별회원현황(회원)
   PURPOSE:
...
*/
    ...
    ls_sql_main :=                  '   SELECT  TOT.COMP_CD                '
                ...
                ||chr(13)||chr(10)||'   AND     TOT.COMP_CD  = LVL.COMP_CD      '
                ||chr(13)||chr(10)||'   AND     TOT.CUST_LVL = LVL.LVL_CD       '
                ...
                ||chr(13)||chr(10)||'   ORDER BY TOT.COMP_CD, TOT.STOR_CD, TOT.SALE_YM, LVL.LVL_RANK,  TOT.CUST_ID, TOT.ITEM_CD        '
        ;
