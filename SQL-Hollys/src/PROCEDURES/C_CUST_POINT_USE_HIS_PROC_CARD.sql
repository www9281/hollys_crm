--------------------------------------------------------
--  DDL for Procedure C_CUST_POINT_USE_HIS_PROC_CARD
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."C_CUST_POINT_USE_HIS_PROC_CARD" (
...
END C_CUST_POINT_USE_HIS_PROC_CARD;
