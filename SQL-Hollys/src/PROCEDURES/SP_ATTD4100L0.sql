--------------------------------------------------------
--  DDL for Procedure SP_ATTD4100L0
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_ATTD4100L0" 
(
...
--     dbms_output.put_line(ls_sql) ;
  ...
  OPEN PR_RESULT FOR V_SQL USING PSV_COMP_CD, PSV_LANG_CD, PSV_COMP_CD, PSV_COMP_CD, PSV_LANG_CD, PSV_COMP_CD, PSV_COMP_CD;
