--------------------------------------------------------
--  DDL for Procedure SP_MEAN1010L1
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_MEAN1010L1" /* 회원통계정보-전체회원현황(점포) */
(
...
*/
    ...
    ls_sql_main :=                  '   SELECT  MSS.COMP_CD                '
                ...
                ||chr(13)||chr(10)||'         , CASE WHEN CST_BILL_CNT = 0 THEN 0 ELSE MSS.CST_GRD_AMT / MSS.CST_BILL_CNT END AS CST_BILL_AMT  '
                ||chr(13)||chr(10)||'         , CASE WHEN (SUM(CST_BILL_CNT) OVER()) = 0 THEN 0    '
                ||chr(13)||chr(10)||'                ELSE (SUM(MSS.CST_GRD_AMT) OVER()) / (SUM(MSS.CST_BILL_CNT) OVER()) END AS T_CST_BILL_AMT '
                ...
                ||chr(13)||chr(10)||'   ORDER BY MSS.COMP_CD, MSS.STOR_CD, MSS.SALE_YM             '
        ;
