--------------------------------------------------------
--  DDL for Procedure SP_CROWN_BEAN_BUY_TIME
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "CRMDEV"."SP_CROWN_BEAN_BUY_TIME" 
   (
    ...
    CURSOR CUR_1 IS
        SELECT  UNIQUE
              ...
              , STOR_CD
        FROM    SALE_HD
        WHERE   SALE_DT = NVL(PSV_SALE_DT, TO_CHAR(SYSDATE, 'YYYYMMDD'));
