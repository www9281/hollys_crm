--------------------------------------------------------
--  DDL for Function FN_RCP_STD_0073
--------------------------------------------------------

  CREATE OR REPLACE FUNCTION "CRMDEV"."FN_RCP_STD_0073" (
...
RETURN TBL_RECIPE_BRAND_FOOD_RPC AS
    /****************************************************************/
    /*      판매레시피 소요량 분석화면[SALE1180L0] 전용 프로시져    */
    /*      조회시점에서 유효한 레시피정보를 조회한다(불출여부:YES, 사용여부:YES)    */
    /****************************************************************/
    CURSOR CUR_1 IS
